...
export const closingConditions: ConditionPrecedent[] = [
  // Corporate Documents
  {
    ...
    status: 'satisfied',
    dueDate: new Date('2028-02-10'),
    satisfiedAt: new Date('2028-01-28'),
  ...
  },
  {
    ...
    responsiblePartyId: 'party-1',
    status: 'satisfied',
    dueDate: new Date('2028-02-12'),
    satisfiedAt: new Date('2028-01-30'),
  ...
  // Security Documents
  {
    ...
    status: 'satisfied',
    dueDate: new Date('2028-02-12'),
    satisfiedAt: new Date('2028-01-31'),
  ...
  // Legal Opinions
  {
    ...
    description: 'Legal opinion of Merrick Callan as to the Borrower',
    responsiblePartyId: 'party-5',
    status: 'pending',
    dueDate: new Date('2028-02-14'),
    satisfiedAt: null,
  ...
  // KYC/AML
  {
    ...
    responsiblePartyId: 'party-1',
    status: 'satisfied',
    dueDate: new Date('2028-02-05'),
    satisfiedAt: new Date('2028-01-25'),
    satisfiedByDocumentIds: [],
    waivedAt: null,
    waiverApprovedBy: null,
    notes: '',
  ...
  // Financial
  {
    ...
    status: 'satisfied',
    dueDate: new Date('2028-02-01'),
    satisfiedAt: new Date('2028-01-20'),
  ...
  },
  {
    ...
    status: 'satisfied',
    dueDate: new Date('2028-02-05'),
    satisfiedAt: new Date('2028-01-22'),
...
export const closingDocuments: Document[] = [
  // Satisfied CP documents
  {
    ...
    status: 'uploaded',
    responsiblePartyId: 'party-1',
    uploadedAt: new Date('2028-01-28'),
    uploadedBy: 'alan.pierce@example.com',
    dueDate: new Date('2028-02-10'),
    signatures: [],
  ...
  },
  {
    ...
    status: 'uploaded',
    responsiblePartyId: 'party-1',
    uploadedAt: new Date('2028-01-30'),
    uploadedBy: 'alan.pierce@example.com',
    dueDate: new Date('2028-02-12'),
    signatures: [],
  ...
  // Credit Agreement - needs signatures
  {
    ...
    status: 'pending',
    responsiblePartyId: 'party-5',
    uploadedAt: new Date('2028-01-31'),
    ...
    signatures: [
      ...
      },
      {
        ...
        status: 'signed',
        signedAt: new Date('2028-02-01'),
      },
      {
        id: 'sig-3',
        documentId: 'doc-4',
        partyId: 'party-3',
        signatoryName: 'Henry Adler',
  ...
  // Financial documents
  {
    ...
    status: 'uploaded',
    responsiblePartyId: 'party-1',
    uploadedAt: new Date('2028-01-20'),
    uploadedBy: 'cfo@example.com',
    dueDate: new Date('2028-02-01'),
    signatures: [],
  ...
  },
  {
    ...
    status: 'uploaded',
    responsiblePartyId: 'party-1',
    uploadedAt: new Date('2028-01-22'),
    uploadedBy: 'cfo@example.com',
    dueDate: new Date('2028-02-05'),
    signatures: [],
