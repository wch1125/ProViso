...
BASKET PermittedAcquisitions CAPACITY $75_000_000 SUBJECT TO ProFormaCompliance`,
    ...
    generatedWordDoc: null,
    changeSummary: {
      versionFrom: 1, versionTo: 2, authorParty: 'Davis Polk', createdAt: new Date('2028-01-15T14:30:00Z'),
  ...
  },
  {
    ...
    generatedWordDoc: null,
    changeSummary: {
      versionFrom: 2, versionTo: 3, authorParty: 'Simpson Thacher', createdAt: new Date('2028-01-20T10:15:00Z'),
...
const abcClosingConditions: ConditionPrecedent[] = [
  ...
  // ── Legal Opinions (4) ──
  { id: 'abc-cond-23', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(e)(i)', category: 'legal_opinions', title: 'Borrower Counsel Opinion', description: 'Legal opinion of Davis Polk covering enforceability, no conflicts, authorization, and corporate matters', responsiblePartyId: 'abc-cp-5', status: 'pending', dueDate: new Date('2028-02-14'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Draft under review by Agent Counsel' },
...
const abcClosingDocuments: ClosingDocument[] = [
  ...
  { id: 'abc-doc-1', dealId: 'abc-acquisition', documentType: 'credit_agreement', title: 'Credit Agreement', fileName: 'ABC_Credit_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/abc-doc-1.pdf', status: 'pending', responsiblePartyId: 'abc-cp-5', uploadedAt: new Date('2028-01-31'), uploadedBy: 'partner@davispolk.com', dueDate: new Date('2028-02-15'), signatures: [
    { id: 'abc-sig-1', documentId: 'abc-doc-1', partyId: 'abc-cp-2', signatoryName: 'Sarah Johnson', signatoryTitle: 'Managing Director', status: 'signed', signedAt: new Date('2028-02-01') },
    ...
    { id: 'abc-sig-4', documentId: 'abc-doc-1', partyId: 'abc-cp-1', signatoryName: 'John Smith', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-01-31') },
  ], satisfiesConditionIds: ['abc-cond-1'] },
  { id: 'abc-doc-2', dealId: 'abc-acquisition', documentType: 'credit_agreement', title: 'Commitment Letter', fileName: 'ABC_Commitment_Letter.pdf', fileType: 'application/pdf', storagePath: '/documents/abc-doc-2.pdf', status: 'executed', responsiblePartyId: 'abc-cp-2', uploadedAt: new Date('2028-01-15'), uploadedBy: 'sjohnson@fnb.com', dueDate: new Date('2028-01-20'), signatures: [
    { id: 'abc-sig-5', documentId: 'abc-doc-2', partyId: 'abc-cp-2', signatoryName: 'Sarah Johnson', signatoryTitle: 'Managing Director', status: 'signed', signedAt: new Date('2028-01-15') },
    { id: 'abc-sig-6', documentId: 'abc-doc-2', partyId: 'abc-cp-1', signatoryName: 'John Smith', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-01-15') },
  ], satisfiesConditionIds: ['abc-cond-2'] },
  { id: 'abc-doc-3', dealId: 'abc-acquisition', documentType: 'credit_agreement', title: 'Fee Letter', fileName: 'ABC_Fee_Letter.pdf', fileType: 'application/pdf', storagePath: '/documents/abc-doc-3.pdf', status: 'executed', responsiblePartyId: 'abc-cp-2', uploadedAt: new Date('2028-01-20'), uploadedBy: 'sjohnson@fnb.com', dueDate: new Date('2028-01-25'), signatures: [
    { id: 'abc-sig-7', documentId: 'abc-doc-3', partyId: 'abc-cp-2', signatoryName: 'Sarah Johnson', signatoryTitle: 'Managing Director', status: 'signed', signedAt: new Date('2028-01-20') },
    { id: 'abc-sig-8', documentId: 'abc-doc-3', partyId: 'abc-cp-1', signatoryName: 'John Smith', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-01-20') },
    { id: 'abc-sig-9', documentId: 'abc-doc-3', partyId: 'abc-cp-5', signatoryName: 'James Wilson', signatoryTitle: 'Partner', status: 'signed', signedAt: new Date('2028-01-20') },
  ], satisfiesConditionIds: ['abc-cond-3'] },
  { id: 'abc-doc-4', dealId: 'abc-acquisition', documentType: 'credit_agreement', title: 'Funds Flow Memorandum', fileName: 'ABC_Funds_Flow_Memo.pdf', fileType: 'application/pdf', storagePath: '/documents/abc-doc-4.pdf', status: 'pending', responsiblePartyId: 'abc-cp-2', uploadedAt: new Date('2028-02-05'), uploadedBy: 'sjohnson@fnb.com', dueDate: new Date('2028-02-14'), signatures: [], satisfiesConditionIds: ['abc-cond-5'] },
  // ── Security Documents ──
  { id: 'abc-doc-5', dealId: 'abc-acquisition', documentType: 'security', title: 'Security Agreement', fileName: 'ABC_Security_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/abc-doc-5.pdf', status: 'executed', responsiblePartyId: 'abc-cp-5', uploadedAt: new Date('2028-01-31'), uploadedBy: 'partner@davispolk.com', dueDate: new Date('2028-02-12'), signatures: [
    { id: 'abc-sig-10', documentId: 'abc-doc-5', partyId: 'abc-cp-2', signatoryName: 'Sarah Johnson', signatoryTitle: 'Managing Director', status: 'signed', signedAt: new Date('2028-01-31') },
    { id: 'abc-sig-11', documentId: 'abc-doc-5', partyId: 'abc-cp-1', signatoryName: 'John Smith', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-01-31') },
    { id: 'abc-sig-12', documentId: 'abc-doc-5', partyId: 'abc-cp-7', signatoryName: 'Richard Clarke', signatoryTitle: 'General Counsel', status: 'signed', signedAt: new Date('2028-02-01') },
...
const solarNegotiationVersions: DealVersion[] = [
  { id: 'solar-version-1', dealId: 'solar-demo', versionNumber: 1, versionLabel: "Lender's Initial Draft", creditLangCode: '// Solar - Lender Initial\nCOVENANT MinDSCR REQUIRES DSCR >= 1.35 TESTED QUARTERLY', createdBy: 'jwalsh@milbank.com', authorParty: 'Milbank', createdAt: new Date('2027-11-01'), parentVersionId: null, status: 'superseded', generatedWordDoc: null, changeSummary: null },
  { id: 'solar-version-2', dealId: 'solar-demo', versionNumber: 2, versionLabel: "Sponsor's Markup", creditLangCode: '// Solar - Sponsor Markup\nCOVENANT MinDSCR REQUIRES DSCR >= 1.20 TESTED QUARTERLY\nDEGRADATION_SCHEDULE PanelDegradation ANNUAL_DEGRADATION 0.5', createdBy: 'david.kim@lw.com', authorParty: 'Latham', createdAt: new Date('2027-11-15'), parentVersionId: 'solar-version-1', status: 'superseded', generatedWordDoc: null, changeSummary: { versionFrom: 1, versionTo: 2, authorParty: 'Latham', createdAt: new Date('2027-11-15'), totalChanges: 2, covenantChanges: 1, definitionChanges: 0, basketChanges: 0, otherChanges: 1, borrowerFavorable: 2, lenderFavorable: 0, neutral: 0, changes: [
  ...
  { id: 'solar-version-3', dealId: 'solar-demo', versionNumber: 3, versionLabel: 'Agreed Terms', creditLangCode: solarCode, createdBy: 'jwalsh@milbank.com', authorParty: 'Milbank', createdAt: new Date('2027-12-01'), parentVersionId: 'solar-version-2', status: 'draft', generatedWordDoc: null, changeSummary: { versionFrom: 2, versionTo: 3, authorParty: 'Milbank', createdAt: new Date('2027-12-01'), totalChanges: 1, covenantChanges: 1, definitionChanges: 0, basketChanges: 0, otherChanges: 0, borrowerFavorable: 0, lenderFavorable: 1, neutral: 0, changes: [
...
const solarClosingConditions: ConditionPrecedent[] = [
  ...
  // ── Legal Opinions (3) ──
  { id: 'solar-cond-14', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(d)(i)', category: 'legal_opinions', title: 'Borrower Counsel Opinion', description: 'Legal opinion of Latham & Watkins covering enforceability, authorization, and no conflicts', responsiblePartyId: 'solar-cp-4', status: 'pending', dueDate: new Date('2028-02-28'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Draft in preparation' },
  ...
  { id: 'solar-cond-30', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(h)(iv)', category: 'permits', title: 'State Utility Commission Approval', description: 'Arizona Corporation Commission approval of the PPA', responsiblePartyId: 'solar-cp-1', status: 'pending', dueDate: new Date('2028-02-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'OVERDUE — hearing rescheduled to Feb 10' },
  ...
  // ── Technical (4) ──
  { id: 'solar-cond-32', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(i)(i)', category: 'technical', title: 'EPC Contract (Executed)', description: 'Fully executed EPC Contract with First Solar EPC LLC for turnkey construction', responsiblePartyId: 'solar-cp-6', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-01-15'), satisfiedByDocumentIds: ['solar-doc-13'], waivedAt: null, waiverApprovedBy: null, notes: 'Fixed-price $245M, 18-month schedule' },
  ...
  // ── Offtake (3) ──
  { id: 'solar-cond-40', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(k)(i)', category: 'offtake', title: 'Power Purchase Agreement (PPA)', description: 'Executed 25-year PPA with Arizona Public Service at $42/MWh escalating 1.5% annually', responsiblePartyId: 'solar-cp-8', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-01-20'), satisfiedByDocumentIds: ['solar-doc-14'], waivedAt: null, waiverApprovedBy: null, notes: '25-year term with investment-grade offtaker' },
  ...
  // ── Consents (3) ──
  { id: 'solar-cond-43', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(l)(i)', category: 'consents', title: 'Offtaker Consent (Utility)', description: 'Consent of Arizona Public Service to collateral assignment of PPA to Collateral Agent', responsiblePartyId: 'solar-cp-8', status: 'pending', dueDate: new Date('2028-02-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'OVERDUE — utility legal department reviewing' },
  { id: 'solar-cond-44', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(l)(ii)', category: 'consents', title: 'EPC Contractor Consent', description: 'Consent of First Solar EPC to collateral assignment of EPC Contract to Collateral Agent', responsiblePartyId: 'solar-cp-6', status: 'pending', dueDate: new Date('2028-02-25'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'First Solar legal reviewing form' },
...
const solarClosingDocuments: ClosingDocument[] = [
  // ── Credit Agreement Documents ──
  { id: 'solar-doc-1', dealId: 'solar-demo', documentType: 'credit_agreement', title: 'Credit Agreement', fileName: 'DesertSun_Credit_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-1.pdf', status: 'pending', responsiblePartyId: 'solar-cp-4', uploadedAt: new Date('2028-02-10'), uploadedBy: 'david.kim@lw.com', dueDate: new Date('2028-03-01'), signatures: [
  ...
  { id: 'solar-doc-2', dealId: 'solar-demo', documentType: 'credit_agreement', title: 'Depositary Agreement', fileName: 'DesertSun_Depositary_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-2.pdf', status: 'pending', responsiblePartyId: 'solar-cp-2', uploadedAt: new Date('2028-02-08'), uploadedBy: 'twhite@cobank.com', dueDate: new Date('2028-02-28'), signatures: [], satisfiesConditionIds: ['solar-cond-2'] },
  { id: 'solar-doc-3', dealId: 'solar-demo', documentType: 'credit_agreement', title: 'Collateral Agency Agreement', fileName: 'DesertSun_Collateral_Agency.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-3.pdf', status: 'pending', responsiblePartyId: 'solar-cp-5', uploadedAt: new Date('2028-02-08'), uploadedBy: 'jwalsh@milbank.com', dueDate: new Date('2028-03-01'), signatures: [], satisfiesConditionIds: ['solar-cond-3'] },
  { id: 'solar-doc-4', dealId: 'solar-demo', documentType: 'credit_agreement', title: 'Intercreditor Agreement', fileName: 'DesertSun_Intercreditor.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-4.pdf', status: 'pending', responsiblePartyId: 'solar-cp-5', uploadedAt: new Date('2028-02-10'), uploadedBy: 'jwalsh@milbank.com', dueDate: new Date('2028-03-01'), signatures: [], satisfiesConditionIds: ['solar-cond-4'] },
  // ── Security Documents ──
  { id: 'solar-doc-5', dealId: 'solar-demo', documentType: 'security', title: 'Security Agreement', fileName: 'DesertSun_Security_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-5.pdf', status: 'executed', responsiblePartyId: 'solar-cp-4', uploadedAt: new Date('2028-02-10'), uploadedBy: 'david.kim@lw.com', dueDate: new Date('2028-02-20'), signatures: [
    { id: 'solar-sig-3', documentId: 'solar-doc-5', partyId: 'solar-cp-1', signatoryName: 'Robert Martinez', signatoryTitle: 'Project Director', status: 'signed', signedAt: new Date('2028-02-10') },
    { id: 'solar-sig-4', documentId: 'solar-doc-5', partyId: 'solar-cp-2', signatoryName: 'Thomas White', signatoryTitle: 'Managing Director', status: 'signed', signedAt: new Date('2028-02-10') },
  ...
  { id: 'solar-doc-6', dealId: 'solar-demo', documentType: 'security', title: 'Pledge Agreement', fileName: 'DesertSun_Pledge_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-6.pdf', status: 'executed', responsiblePartyId: 'solar-cp-4', uploadedAt: new Date('2028-02-10'), uploadedBy: 'david.kim@lw.com', dueDate: new Date('2028-02-20'), signatures: [
    { id: 'solar-sig-5', documentId: 'solar-doc-6', partyId: 'solar-cp-1', signatoryName: 'Amanda Lee', signatoryTitle: 'CFO, Sponsor', status: 'signed', signedAt: new Date('2028-02-10') },
  ], satisfiesConditionIds: ['solar-cond-6'] },
  { id: 'solar-doc-7', dealId: 'solar-demo', documentType: 'security', title: 'Mortgage/Deed of Trust', fileName: 'DesertSun_Mortgage.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-7.pdf', status: 'pending', responsiblePartyId: 'solar-cp-4', uploadedAt: new Date('2028-02-12'), uploadedBy: 'david.kim@lw.com', dueDate: new Date('2028-02-28'), signatures: [], satisfiesConditionIds: ['solar-cond-7'] },
  { id: 'solar-doc-8', dealId: 'solar-demo', documentType: 'security', title: 'Assignment of Project Contracts', fileName: 'DesertSun_Contract_Assignment.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-8.pdf', status: 'pending', responsiblePartyId: 'solar-cp-4', uploadedAt: new Date('2028-02-12'), uploadedBy: 'david.kim@lw.com', dueDate: new Date('2028-02-28'), signatures: [], satisfiesConditionIds: ['solar-cond-8'] },
  // ── Technical / IE ──
  { id: 'solar-doc-9', dealId: 'solar-demo', documentType: 'technical', title: 'Independent Engineer Report', fileName: 'DesertSun_IE_Report_Leidos.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-9.pdf', status: 'uploaded', responsiblePartyId: 'solar-cp-7', uploadedAt: new Date('2028-02-05'), uploadedBy: 'engineer@leidos.com', dueDate: new Date('2028-02-15'), signatures: [], satisfiesConditionIds: ['solar-cond-19', 'solar-cond-33'] },
  // ── Financial Documents ──
  { id: 'solar-doc-10', dealId: 'solar-demo', documentType: 'financial', title: 'Financial Model (Base Case)', fileName: 'DesertSun_Financial_Model.xlsx', fileType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', storagePath: '/documents/solar-doc-10.xlsx', status: 'uploaded', responsiblePartyId: 'solar-cp-1', uploadedAt: new Date('2028-02-01'), uploadedBy: 'rmartinez@desertsun.com', dueDate: new Date('2028-02-15'), signatures: [], satisfiesConditionIds: ['solar-cond-21'] },
  { id: 'solar-doc-11', dealId: 'solar-demo', documentType: 'financial', title: 'Construction Budget', fileName: 'DesertSun_Construction_Budget.xlsx', fileType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', storagePath: '/documents/solar-doc-11.xlsx', status: 'uploaded', responsiblePartyId: 'solar-cp-1', uploadedAt: new Date('2028-02-02'), uploadedBy: 'rmartinez@desertsun.com', dueDate: new Date('2028-02-15'), signatures: [], satisfiesConditionIds: ['solar-cond-22'] },
  // ── Offtake / Interconnection ──
  { id: 'solar-doc-12', dealId: 'solar-demo', documentType: 'offtake', title: 'Interconnection Agreement', fileName: 'DesertSun_LGIA.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-12.pdf', status: 'executed', responsiblePartyId: 'solar-cp-1', uploadedAt: new Date('2028-01-25'), uploadedBy: 'rmartinez@desertsun.com', dueDate: new Date('2028-02-20'), signatures: [
    { id: 'solar-sig-6', documentId: 'solar-doc-12', partyId: 'solar-cp-1', signatoryName: 'Robert Martinez', signatoryTitle: 'Project Director', status: 'signed', signedAt: new Date('2028-01-25') },
  ], satisfiesConditionIds: ['solar-cond-29', 'solar-cond-41'] },
  // ── EPC Contract ──
  { id: 'solar-doc-13', dealId: 'solar-demo', documentType: 'technical', title: 'EPC Contract', fileName: 'DesertSun_EPC_Contract.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-13.pdf', status: 'executed', responsiblePartyId: 'solar-cp-6', uploadedAt: new Date('2028-01-15'), uploadedBy: 'contracts@firstsolar.com', dueDate: new Date('2028-02-15'), signatures: [
    { id: 'solar-sig-7', documentId: 'solar-doc-13', partyId: 'solar-cp-1', signatoryName: 'Robert Martinez', signatoryTitle: 'Project Director', status: 'signed', signedAt: new Date('2028-01-15') },
    { id: 'solar-sig-8', documentId: 'solar-doc-13', partyId: 'solar-cp-6', signatoryName: 'Mark Torres', signatoryTitle: 'VP, EPC Projects', status: 'signed', signedAt: new Date('2028-01-15') },
  ], satisfiesConditionIds: ['solar-cond-32'] },
  // ── PPA ──
  { id: 'solar-doc-14', dealId: 'solar-demo', documentType: 'offtake', title: 'Power Purchase Agreement (PPA)', fileName: 'DesertSun_PPA.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-14.pdf', status: 'executed', responsiblePartyId: 'solar-cp-8', uploadedAt: new Date('2028-01-20'), uploadedBy: 'rmartinez@desertsun.com', dueDate: new Date('2028-02-15'), signatures: [
    { id: 'solar-sig-9', documentId: 'solar-doc-14', partyId: 'solar-cp-1', signatoryName: 'Robert Martinez', signatoryTitle: 'Project Director', status: 'signed', signedAt: new Date('2028-01-20') },
    { id: 'solar-sig-10', documentId: 'solar-doc-14', partyId: 'solar-cp-8', signatoryName: 'Patricia Nguyen', signatoryTitle: 'VP, Power Supply', status: 'signed', signedAt: new Date('2028-01-20') },
  ], satisfiesConditionIds: ['solar-cond-40'] },
  // ── Tax Equity Partnership ──
  { id: 'solar-doc-15', dealId: 'solar-demo', documentType: 'tax_equity', title: 'Tax Equity Partnership Agreement (Draft)', fileName: 'DesertSun_TEPA_Draft.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-15.pdf', status: 'pending', responsiblePartyId: 'solar-cp-3', uploadedAt: new Date('2028-02-08'), uploadedBy: 'kchen@taxequityfund.com', dueDate: new Date('2028-02-28'), signatures: [
...
const windNegotiationVersions: DealVersion[] = [
  { id: 'wind-version-1', dealId: 'wind-demo', versionNumber: 1, versionLabel: "Lender's Initial Draft", creditLangCode: '// Wind - Lender Initial\nCOVENANT MinDSCR REQUIRES DSCR >= 1.40', createdBy: 'rgreen@paulweiss.com', authorParty: 'Paul Weiss', createdAt: new Date('2027-10-01'), parentVersionId: null, status: 'superseded', generatedWordDoc: null, changeSummary: null },
  { id: 'wind-version-2', dealId: 'wind-demo', versionNumber: 2, versionLabel: "Sponsor's Markup", creditLangCode: '// Wind - Sponsor Markup\nCOVENANT MinDSCR REQUIRES DSCR >= 1.25\nCOVENANT CurtailmentLimit REQUIRES curtailment_pct <= 7.0', createdBy: 'mstevens@kirkland.com', authorParty: 'Kirkland', createdAt: new Date('2027-10-20'), parentVersionId: 'wind-version-1', status: 'superseded', generatedWordDoc: null, changeSummary: { versionFrom: 1, versionTo: 2, authorParty: 'Kirkland', createdAt: new Date('2027-10-20'), totalChanges: 2, covenantChanges: 2, definitionChanges: 0, basketChanges: 0, otherChanges: 0, borrowerFavorable: 2, lenderFavorable: 0, neutral: 0, changes: [
  ...
  { id: 'wind-version-3', dealId: 'wind-demo', versionNumber: 3, versionLabel: 'Agreed Terms', creditLangCode: windCode, createdBy: 'rgreen@paulweiss.com', authorParty: 'Paul Weiss', createdAt: new Date('2027-11-15'), parentVersionId: 'wind-version-2', status: 'draft', generatedWordDoc: null, changeSummary: { versionFrom: 2, versionTo: 3, authorParty: 'Paul Weiss', createdAt: new Date('2027-11-15'), totalChanges: 1, covenantChanges: 1, definitionChanges: 0, basketChanges: 0, otherChanges: 0, borrowerFavorable: 0, lenderFavorable: 1, neutral: 0, changes: [
...
const windClosingConditions: ConditionPrecedent[] = [
  ...
  // ── Legal Opinions (3) ──
  { id: 'wind-cond-12', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(d)(i)', category: 'legal_opinions', title: 'Borrower Counsel Opinion', description: 'Legal opinion of Kirkland & Ellis covering enforceability, authorization, and no conflicts', responsiblePartyId: 'wind-cp-3', status: 'pending', dueDate: new Date('2028-02-18'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Draft in preparation' },
  ...
  { id: 'wind-cond-27', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(h)(iv)', category: 'permits', title: 'State Utility Commission Approval', description: 'Oklahoma Corporation Commission approval of power purchase structure', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-01'), satisfiedAt: new Date('2028-01-18'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  ...
  // ── Technical (4) ──
  { id: 'wind-cond-29', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(i)(i)', category: 'technical', title: 'Turbine Supply Agreement', description: 'Fully executed Turbine Supply Agreement with Vestas for 36x V150-4.2 MW turbines', responsiblePartyId: 'wind-cp-5', status: 'satisfied', dueDate: new Date('2028-02-01'), satisfiedAt: new Date('2028-01-15'), satisfiedByDocumentIds: ['wind-doc-9'], waivedAt: null, waiverApprovedBy: null, notes: 'V150-4.2 MW, hub height 105m' },
  ...
  // ── Consents (2) ──
  { id: 'wind-cond-36', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(k)(i)', category: 'consents', title: 'Turbine OEM Consent', description: 'Consent of Vestas to collateral assignment of Turbine Supply Agreement to Collateral Agent', responsiblePartyId: 'wind-cp-5', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Vestas legal reviewing form of consent' },
  { id: 'wind-cond-37', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(k)(ii)', category: 'consents', title: 'O&M Provider Consent', description: 'Consent of Vestas Service to collateral assignment of O&M Agreement', responsiblePartyId: 'wind-cp-5', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Due Diligence (3) ──
...
const corporateNegotiationVersions: DealVersion[] = [
  { id: 'corp-version-1', dealId: 'corporate-demo', versionNumber: 1, versionLabel: "Lender's Initial Draft", creditLangCode: '// Corporate - Lender Initial\nCOVENANT MaxLeverage REQUIRES Leverage <= 4.25\nBASKET GeneralInvestments CAPACITY $20_000_000', createdBy: 'sclark@cahill.com', authorParty: 'Cahill', createdAt: new Date('2026-05-01'), parentVersionId: null, status: 'superseded', generatedWordDoc: null, changeSummary: null },
  { id: 'corp-version-2', dealId: 'corporate-demo', versionNumber: 2, versionLabel: "Borrower's Markup", creditLangCode: '// Corporate - Borrower Markup\nCOVENANT MaxLeverage REQUIRES Leverage <= 4.75 CURE EquityCure MAX_USES 3\nBASKET GeneralInvestments CAPACITY $30_000_000\nBASKET EBITDAInvestments CAPACITY 0.20 * EBITDA FLOOR $20_000_000', createdBy: 'ablake@stblaw.com', authorParty: 'Simpson Thacher', createdAt: new Date('2026-05-15'), parentVersionId: 'corp-version-1', status: 'superseded', generatedWordDoc: null, changeSummary: { versionFrom: 1, versionTo: 2, authorParty: 'Simpson Thacher', createdAt: new Date('2026-05-15'), totalChanges: 3, covenantChanges: 1, definitionChanges: 0, basketChanges: 2, otherChanges: 0, borrowerFavorable: 3, lenderFavorable: 0, neutral: 0, changes: [
...
const corporateNegotiationDeal: Deal = {
  id: 'corporate-demo', name: 'Apex Industries Credit Facility', dealType: 'corporate', facilityAmount: 150_000_000, currency: 'USD', status: 'active', currentVersionId: 'corp-version-3', parties: corporateNegotiationParties, targetClosingDate: new Date('2026-06-15'), actualClosingDate: new Date('2026-06-15'), maturityDate: new Date('2031-06-15'), createdAt: new Date('2026-04-15'), updatedAt: new Date('2026-06-15'), createdBy: 'bmitchell@jpmorgan.com',
};
...
const corporateClosingDocuments: ClosingDocument[] = [
  { id: 'corp-doc-1', dealId: 'corporate-demo', documentType: 'credit_agreement', title: 'Credit Agreement', fileName: 'Apex_Credit_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/corp-doc-1.pdf', status: 'executed', responsiblePartyId: 'corp-cp-3', uploadedAt: new Date('2026-06-15'), uploadedBy: 'ablake@stblaw.com', dueDate: new Date('2026-06-15'), signatures: [], satisfiesConditionIds: ['corp-cond-1'] },
];

const corporateClosingDeal: ClosingDeal = { id: 'corporate-demo', name: 'Apex Industries Credit Facility', facilityAmount: 150_000_000, currency: 'USD', targetClosingDate: new Date('2026-06-15'), status: 'active' };
