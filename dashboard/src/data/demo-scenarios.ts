...
const solarCode = `// Coyote Mesa Solar Project
...
const windCode = `// Ridgeline Wind Farm
...
CONDITIONS_PRECEDENT InitialFunding
  ...
  CP TurbineSupplyAgreement
    DESCRIPTION "Executed TSA with Galewind"
    RESPONSIBLE Borrower
    STATUS satisfied
...
const corporateCode = `// Calderon Industries Credit Facility
...
CONDITIONS_PRECEDENT InitialClosing
  ...
  CP BorrowerCounselOpinion
    DESCRIPTION "Legal opinion of Merrick Callan"
    RESPONSIBLE BorrowerCounsel
    STATUS pending

  CP AgentCounselOpinion
    DESCRIPTION "Legal opinion of Whitfield & Barr"
...
const abcNegotiationParties: DealParty[] = [
  {
    ...
    role: 'borrower',
    partyType: 'borrower',
    primaryContact: { name: 'Monica Ellis', email: 'mellis@example.com', phone: '+1 (212) 555-0101', title: 'CFO' },
    additionalContacts: [{ name: 'Steven Cole', email: 'scole@example.com', phone: '+1 (212) 555-0102', title: 'Treasurer' }],
    counselPartyId: 'abc-party-merrick-callan',
  },
  {
    id: 'abc-party-agent',
    dealId: 'abc-acquisition',
    ...
    partyType: 'agent',
    primaryContact: { name: 'Dana Frost', email: 'dfrost@example.com', phone: '+1 (212) 555-0201', title: 'Managing Director' },
    additionalContacts: [],
    counselPartyId: 'abc-party-whitfield-barr',
  },
  {
    id: 'abc-party-merrick-callan',
    dealId: 'abc-acquisition',
    name: 'Merrick Callan & Hoyt LLP',
    shortName: 'Merrick Callan',
    role: 'borrower',
    partyType: 'law_firm',
    primaryContact: { name: 'Diane Foster', email: 'diane.foster@example.com', phone: '+1 (212) 555-0401', title: 'Partner' },
    additionalContacts: [],
    counselPartyId: null,
  },
  {
    id: 'abc-party-whitfield-barr',
    dealId: 'abc-acquisition',
    name: 'Whitfield & Barr LLP',
    shortName: 'Whitfield & Barr',
    role: 'administrative_agent',
    partyType: 'law_firm',
    primaryContact: { name: 'Peter Nolan', email: 'pnolan@example.com', phone: '+1 (212) 555-0501', title: 'Partner' },
    additionalContacts: [],
    counselPartyId: null,
  },
];
...
BASKET PermittedAcquisitions CAPACITY $75_000_000 SUBJECT TO ProFormaCompliance`,
    ...
    generatedWordDoc: null,
    changeSummary: {
      versionFrom: 1, versionTo: 2, authorParty: 'Merrick Callan', createdAt: new Date('2028-01-15T14:30:00Z'),
  ...
  },
  {
    ...
    generatedWordDoc: null,
    changeSummary: {
      versionFrom: 2, versionTo: 3, authorParty: 'Whitfield & Barr', createdAt: new Date('2028-01-20T10:15:00Z'),
...
const abcNegotiationDeal: Deal = {
  ...
  targetClosingDate: new Date('2028-03-15'),
...
const abcClosingParties: ClosingParty[] = [
  ...
  { id: 'abc-cp-3', dealId: 'abc-acquisition', name: 'Rampart Capital Partners', shortName: 'Lender 1', role: 'lender', partyType: 'lender' },
  { id: 'abc-cp-4', dealId: 'abc-acquisition', name: 'Anchor Credit Fund', shortName: 'Lender 2', role: 'lender', partyType: 'lender' },
  { id: 'abc-cp-5', dealId: 'abc-acquisition', name: 'Merrick Callan & Hoyt', shortName: 'Borrower Counsel', role: 'counsel', partyType: 'law_firm' },
  { id: 'abc-cp-6', dealId: 'abc-acquisition', name: 'Whitfield & Barr', shortName: 'Agent Counsel', role: 'counsel', partyType: 'law_firm' },
  { id: 'abc-cp-7', dealId: 'abc-acquisition', name: 'ABC Parent Corp.', shortName: 'Parent/HoldCo', role: 'guarantor', partyType: 'borrower' },
  { id: 'abc-cp-8', dealId: 'abc-acquisition', name: 'Sutcliffe Kane & Rowe', shortName: 'Local Counsel (NY)', role: 'counsel', partyType: 'law_firm' },
];

const abcClosingConditions: ConditionPrecedent[] = [
  // ── Credit Agreement (5) ──
  { id: 'abc-cond-1', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(a)(i)', category: 'credit_agreement', title: 'Credit Agreement Execution', description: 'Fully executed Credit Agreement among Borrower, Lenders, and Administrative Agent', responsiblePartyId: 'abc-cp-5', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Final signatures pending from Lender 1 and Lender 2' },
  { id: 'abc-cond-2', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(a)(ii)', category: 'credit_agreement', title: 'Commitment Letter', description: 'Executed Commitment Letter from each Lender', responsiblePartyId: 'abc-cp-2', status: 'satisfied', dueDate: new Date('2028-01-20'), satisfiedAt: new Date('2028-01-15'), satisfiedByDocumentIds: ['abc-doc-2'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-3', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(a)(iii)', category: 'credit_agreement', title: 'Fee Letter', description: 'Executed Fee Letter between Borrower and Administrative Agent', responsiblePartyId: 'abc-cp-2', status: 'satisfied', dueDate: new Date('2028-01-25'), satisfiedAt: new Date('2028-01-20'), satisfiedByDocumentIds: ['abc-doc-3'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-4', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(a)(iv)', category: 'credit_agreement', title: 'Closing Certificate', description: 'Borrower closing certificate certifying representations, no default, and satisfaction of conditions', responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Will be executed on closing date' },
  { id: 'abc-cond-5', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(a)(v)', category: 'credit_agreement', title: 'Funds Flow Memorandum', description: 'Executed funds flow memorandum setting forth all closing date payments and wire instructions', responsiblePartyId: 'abc-cp-2', status: 'pending', dueDate: new Date('2028-02-14'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Draft circulated, awaiting final wire instructions' },
  // ── Security Documents (6) ──
  { id: 'abc-cond-6', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(b)(i)', category: 'security_documents', title: 'Security Agreement', description: 'Security Agreement granting first-priority security interest in substantially all personal property assets of the Borrower', responsiblePartyId: 'abc-cp-5', status: 'satisfied', dueDate: new Date('2028-02-12'), satisfiedAt: new Date('2028-01-31'), satisfiedByDocumentIds: ['abc-doc-5'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-7', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(b)(ii)', category: 'security_documents', title: 'Pledge Agreement', description: 'Pledge Agreement covering 100% of equity interests in domestic subsidiaries and 65% of first-tier foreign subsidiaries', responsiblePartyId: 'abc-cp-5', status: 'satisfied', dueDate: new Date('2028-02-12'), satisfiedAt: new Date('2028-01-31'), satisfiedByDocumentIds: ['abc-doc-6'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-8', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(b)(iii)', category: 'security_documents', title: 'Guaranty', description: 'Unconditional guaranty from Parent and each material domestic subsidiary', responsiblePartyId: 'abc-cp-7', status: 'satisfied', dueDate: new Date('2028-02-12'), satisfiedAt: new Date('2028-02-01'), satisfiedByDocumentIds: ['abc-doc-7'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-9', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(b)(iv)', category: 'security_documents', title: 'Account Control Agreements', description: 'Deposit account control agreements for all material deposit and securities accounts', responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-02-14'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Awaiting executed copies from 2 depository banks' },
  { id: 'abc-cond-10', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(b)(v)', category: 'security_documents', title: 'IP Security Agreement', description: 'Intellectual Property Security Agreement covering trademarks, patents, and copyrights', responsiblePartyId: 'abc-cp-5', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-02-03'), satisfiedByDocumentIds: ['abc-doc-8'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-11', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(b)(vi)', category: 'security_documents', title: 'Perfection Certificate', description: 'Perfection Certificate identifying all collateral locations, entity names, and filing jurisdictions', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-02-02'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── UCC Filings (3) ──
  { id: 'abc-cond-12', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(c)(i)', category: 'ucc_filings', title: 'UCC-1 Financing Statement (Borrower)', description: 'UCC-1 Financing Statement naming Borrower as debtor, filed with Delaware Secretary of State', responsiblePartyId: 'abc-cp-6', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Will file on closing date' },
  { id: 'abc-cond-13', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(c)(ii)', category: 'ucc_filings', title: 'UCC-1 Financing Statement (Guarantor)', description: 'UCC-1 Financing Statement naming Parent/Guarantor as debtor', responsiblePartyId: 'abc-cp-6', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Will file on closing date' },
  { id: 'abc-cond-14', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(c)(iii)', category: 'ucc_filings', title: 'Lien Search Results', description: 'UCC, tax lien, judgment, and litigation search results for Borrower and Guarantor in all relevant jurisdictions', responsiblePartyId: 'abc-cp-6', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-02-04'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'No adverse findings' },
  // ── Corporate Documents (8) ──
  { id: 'abc-cond-15', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(d)(i)', category: 'corporate_documents', title: "Officer's Certificate (Borrower)", description: 'Certificate of a Responsible Officer of the Borrower certifying names, incumbency, and signatures', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-12'), satisfiedAt: new Date('2028-02-05'), satisfiedByDocumentIds: ['abc-doc-9'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-16', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(d)(ii)', category: 'corporate_documents', title: "Officer's Certificate (Parent/Guarantor)", description: 'Certificate of a Responsible Officer of the Parent certifying names, incumbency, and signatures', responsiblePartyId: 'abc-cp-7', status: 'satisfied', dueDate: new Date('2028-02-12'), satisfiedAt: new Date('2028-02-05'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-17', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(d)(iii)', category: 'corporate_documents', title: 'Certificate of Formation (Borrower)', description: 'Certified copy of the Certificate of Formation of the Borrower from Delaware Secretary of State', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-01-28'), satisfiedByDocumentIds: ['abc-doc-10'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-18', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(d)(iv)', category: 'corporate_documents', title: 'LLC Agreement (Borrower)', description: 'Certified copy of the Amended and Restated LLC Agreement of the Borrower', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-01-28'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-19', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(d)(v)', category: 'corporate_documents', title: 'Board Resolutions', description: 'Resolutions of the Board of Directors of the Borrower and Parent authorizing the Transaction and Loan Documents', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-12'), satisfiedAt: new Date('2028-01-30'), satisfiedByDocumentIds: ['abc-doc-11'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-20', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(d)(vi)', category: 'corporate_documents', title: 'Good Standing Certificate (DE)', description: 'Certificate of Good Standing from the Delaware Secretary of State for Borrower', responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-02-14'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Requested — typically 3-5 business day turnaround' },
  { id: 'abc-cond-21', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(d)(vii)', category: 'corporate_documents', title: 'Good Standing Certificate (NY)', description: 'Certificate of Good Standing from the New York Secretary of State for Borrower', responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-02-14'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Requested — expedited processing' },
  { id: 'abc-cond-22', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(d)(viii)', category: 'corporate_documents', title: 'Incumbency Certificate', description: 'Incumbency Certificate for each authorized officer of Borrower and Parent executing Loan Documents', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-12'), satisfiedAt: new Date('2028-02-05'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Legal Opinions (4) ──
  { id: 'abc-cond-23', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(e)(i)', category: 'legal_opinions', title: 'Borrower Counsel Opinion', description: 'Legal opinion of Merrick Callan covering enforceability, no conflicts, authorization, and corporate matters', responsiblePartyId: 'abc-cp-5', status: 'pending', dueDate: new Date('2028-02-14'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Draft under review by Agent Counsel' },
  { id: 'abc-cond-24', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(e)(ii)', category: 'legal_opinions', title: 'Agent Counsel Opinion', description: 'Legal opinion of Whitfield & Barr covering perfection of security interests and UCC matters', responsiblePartyId: 'abc-cp-6', status: 'pending', dueDate: new Date('2028-02-14'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Draft in preparation' },
  { id: 'abc-cond-25', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(e)(iii)', category: 'legal_opinions', title: 'Local Counsel Opinion (NY)', description: 'Legal opinion of local New York counsel on enforceability and good standing in New York', responsiblePartyId: 'abc-cp-8', status: 'pending', dueDate: new Date('2028-02-14'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Engaged Sutcliffe Kane' },
  { id: 'abc-cond-26', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(e)(iv)', category: 'legal_opinions', title: 'Non-Consolidation Opinion', description: 'Non-consolidation opinion confirming separateness of Borrower from Parent for bankruptcy purposes', responsiblePartyId: 'abc-cp-5', status: 'waived', dueDate: new Date('2028-02-12'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: new Date('2028-02-03'), waiverApprovedBy: 'Agent', notes: 'Waived — structure does not require separateness' },
  // ── Certificates (5) ──
  { id: 'abc-cond-27', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(f)(i)', category: 'certificates', title: 'Closing Date Certificate', description: 'Certificate of Borrower certifying that all representations are true and correct in all material respects as of closing', responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'To be delivered at closing' },
  { id: 'abc-cond-28', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(f)(ii)', category: 'certificates', title: 'Solvency Certificate', description: 'Certificate of CFO as to solvency of Borrower and its subsidiaries on a consolidated basis after giving effect to the Transaction', responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-02-14'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'CFO reviewing final form' },
  { id: 'abc-cond-29', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(f)(iii)', category: 'certificates', title: 'Compliance Certificate', description: 'Initial Compliance Certificate demonstrating pro forma covenant compliance as of closing', responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-30', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(f)(iv)', category: 'certificates', title: "Secretary's Certificate", description: "Secretary's Certificate attaching charter, bylaws, and resolutions for Borrower and Parent", responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-12'), satisfiedAt: new Date('2028-02-06'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-31', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(f)(v)', category: 'certificates', title: 'Responsible Officer Certificate', description: "Certificate of Responsible Officer confirming no Material Adverse Effect since latest audited financials", responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Financial (5) ──
  { id: 'abc-cond-32', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(g)(i)', category: 'financial', title: 'Audited Financial Statements', description: 'Audited consolidated financial statements for FY 2023, 2024, and 2025', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-01'), satisfiedAt: new Date('2028-01-20'), satisfiedByDocumentIds: ['abc-doc-14'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-33', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(g)(ii)', category: 'financial', title: 'Pro Forma Financial Model', description: 'Pro forma financial model showing projected covenant compliance through maturity', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-22'), satisfiedByDocumentIds: ['abc-doc-15'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-34', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(g)(iii)', category: 'financial', title: 'Acquisition Pro Forma', description: 'Pro forma balance sheet and income statement giving effect to the Acquisition and initial borrowings', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-25'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-35', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(g)(iv)', category: 'financial', title: 'Quality of Earnings Report', description: 'Quality of Earnings report from independent accounting firm acceptable to Agent', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-01'), satisfiedAt: new Date('2028-01-18'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Prepared by Deloitte' },
  { id: 'abc-cond-36', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(g)(v)', category: 'financial', title: 'Projected Financial Statements', description: 'Board-approved projected financial statements for FY 2026-2030', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-28'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Insurance (3) ──
  { id: 'abc-cond-37', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(h)(i)', category: 'insurance', title: 'Insurance Certificates (GL/Property)', description: 'Certificates of insurance evidencing general liability and property coverage with Agent named as additional insured and loss payee', responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-02-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'OVERDUE — awaiting updated certificates from insurance broker' },
  { id: 'abc-cond-38', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(h)(ii)', category: 'insurance', title: 'D&O Insurance Policy', description: 'Evidence of Directors & Officers liability insurance with coverage amounts satisfactory to Agent', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-02-03'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-39', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(h)(iii)', category: 'insurance', title: 'Evidence of Insurance Premiums Paid', description: 'Evidence that all insurance premiums have been paid current through closing', responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-02-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'OVERDUE — broker confirming premium payment' },
  // ── KYC/AML (3) ──
  { id: 'abc-cond-40', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(i)(i)', category: 'kyc_aml', title: 'KYC Documentation', description: 'Know Your Customer documentation for Borrower and all Guarantors, satisfactory to each Lender', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-25'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-41', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(i)(ii)', category: 'kyc_aml', title: 'Beneficial Ownership Certification', description: 'Beneficial Ownership Certification in the form required by 31 CFR 1010.230', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-25'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-42', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(i)(iii)', category: 'kyc_aml', title: 'OFAC/Sanctions Screening', description: 'Completed OFAC, sanctions, and PEP screening for Borrower, Parent, and all Guarantors', responsiblePartyId: 'abc-cp-2', status: 'satisfied', dueDate: new Date('2028-02-01'), satisfiedAt: new Date('2028-01-22'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Clear — no matches' },
  // ── Due Diligence (4) ──
  { id: 'abc-cond-43', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(j)(i)', category: 'due_diligence', title: 'Business Due Diligence', description: 'Completion of business due diligence satisfactory to Agent and Required Lenders', responsiblePartyId: 'abc-cp-2', status: 'satisfied', dueDate: new Date('2028-01-31'), satisfiedAt: new Date('2028-01-28'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-44', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(j)(ii)', category: 'due_diligence', title: 'Legal Due Diligence', description: 'Completion of legal due diligence including review of material contracts, litigation, and regulatory compliance', responsiblePartyId: 'abc-cp-6', status: 'satisfied', dueDate: new Date('2028-01-31'), satisfiedAt: new Date('2028-01-29'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-45', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(j)(iii)', category: 'due_diligence', title: 'Environmental Assessment', description: 'Phase I Environmental Site Assessment for all owned real property', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-01'), satisfiedAt: new Date('2028-01-20'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'No recognized environmental conditions' },
  { id: 'abc-cond-46', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(j)(iv)', category: 'due_diligence', title: 'Tax Structure Opinion', description: 'Tax opinion confirming structure and treatment of Acquisition for federal and state income tax purposes', responsiblePartyId: 'abc-cp-5', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-30'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Real Estate (4) ──
  { id: 'abc-cond-47', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(k)(i)', category: 'real_estate', title: 'Title Report', description: 'Preliminary title report for all owned real property to be subject to Mortgage', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-28'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'abc-cond-48', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(k)(ii)', category: 'real_estate', title: 'Mortgage/Deed of Trust', description: 'Executed Mortgage or Deed of Trust for each owned real property with appraised value in excess of $5M', responsiblePartyId: 'abc-cp-5', status: 'pending', dueDate: new Date('2028-02-14'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Final form under review by local counsel' },
  { id: 'abc-cond-49', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(k)(iii)', category: 'real_estate', title: 'ALTA Survey', description: 'ALTA/NSPS survey for each mortgaged property', responsiblePartyId: 'abc-cp-1', status: 'waived', dueDate: new Date('2028-02-10'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: new Date('2028-02-04'), waiverApprovedBy: 'Agent', notes: 'Waived — existing surveys within 3 years deemed sufficient' },
  { id: 'abc-cond-50', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.01(k)(iv)', category: 'real_estate', title: 'Environmental Phase I', description: 'Phase I Environmental Site Assessment for each mortgaged property', responsiblePartyId: 'abc-cp-1', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-20'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Post-Closing (5) ──
  { id: 'abc-cond-51', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.02(a)', category: 'post_closing', title: 'Final Title Policy', description: 'Delivery of final ALTA lender title insurance policy for each mortgaged property within 90 days of closing', responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-05-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Post-closing obligation' },
  { id: 'abc-cond-52', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.02(b)', category: 'post_closing', title: 'Recorded Mortgage', description: 'Evidence of recording of Mortgage in each applicable county within 30 days of closing', responsiblePartyId: 'abc-cp-5', status: 'pending', dueDate: new Date('2028-03-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Post-closing obligation' },
  { id: 'abc-cond-53', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.02(c)', category: 'post_closing', title: 'Supplemental Perfection Certificate', description: 'Updated Perfection Certificate reflecting any changes identified after closing', responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-03-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Post-closing obligation' },
  { id: 'abc-cond-54', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.02(d)', category: 'post_closing', title: 'Post-Closing Lien Searches', description: 'Updated UCC, tax lien, and judgment searches confirming first-priority lien status within 30 days', responsiblePartyId: 'abc-cp-6', status: 'pending', dueDate: new Date('2028-03-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Post-closing obligation' },
  { id: 'abc-cond-55', dealId: 'abc-acquisition', versionId: 'abc-version-3', sectionReference: '4.02(e)', category: 'post_closing', title: 'Landlord Estoppels', description: 'Estoppel certificates from landlords for each material leased location within 60 days of closing', responsiblePartyId: 'abc-cp-1', status: 'pending', dueDate: new Date('2028-04-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Post-closing obligation — 3 locations' },
];

const abcClosingDocuments: ClosingDocument[] = [
  // ── Credit Agreement Documents ──
  { id: 'abc-doc-1', dealId: 'abc-acquisition', documentType: 'credit_agreement', title: 'Credit Agreement', fileName: 'ABC_Credit_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/abc-doc-1.pdf', status: 'pending', responsiblePartyId: 'abc-cp-5', uploadedAt: new Date('2028-01-31'), uploadedBy: 'partner@example.com', dueDate: new Date('2028-02-15'), signatures: [
    { id: 'abc-sig-1', documentId: 'abc-doc-1', partyId: 'abc-cp-2', signatoryName: 'Emma Bright', signatoryTitle: 'Managing Director', status: 'signed', signedAt: new Date('2028-02-01') },
    { id: 'abc-sig-2', documentId: 'abc-doc-1', partyId: 'abc-cp-3', signatoryName: 'Henry Adler', signatoryTitle: 'Partner', status: 'requested', signedAt: null },
    { id: 'abc-sig-3', documentId: 'abc-doc-1', partyId: 'abc-cp-4', signatoryName: 'Claire Nunez', signatoryTitle: 'Senior VP', status: 'pending', signedAt: null },
    { id: 'abc-sig-4', documentId: 'abc-doc-1', partyId: 'abc-cp-1', signatoryName: 'Alan Pierce', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-01-31') },
  ], satisfiesConditionIds: ['abc-cond-1'] },
  { id: 'abc-doc-2', dealId: 'abc-acquisition', documentType: 'credit_agreement', title: 'Commitment Letter', fileName: 'ABC_Commitment_Letter.pdf', fileType: 'application/pdf', storagePath: '/documents/abc-doc-2.pdf', status: 'executed', responsiblePartyId: 'abc-cp-2', uploadedAt: new Date('2028-01-15'), uploadedBy: 'ebright@example.com', dueDate: new Date('2028-01-20'), signatures: [
    { id: 'abc-sig-5', documentId: 'abc-doc-2', partyId: 'abc-cp-2', signatoryName: 'Emma Bright', signatoryTitle: 'Managing Director', status: 'signed', signedAt: new Date('2028-01-15') },
    { id: 'abc-sig-6', documentId: 'abc-doc-2', partyId: 'abc-cp-1', signatoryName: 'Alan Pierce', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-01-15') },
  ], satisfiesConditionIds: ['abc-cond-2'] },
  { id: 'abc-doc-3', dealId: 'abc-acquisition', documentType: 'credit_agreement', title: 'Fee Letter', fileName: 'ABC_Fee_Letter.pdf', fileType: 'application/pdf', storagePath: '/documents/abc-doc-3.pdf', status: 'executed', responsiblePartyId: 'abc-cp-2', uploadedAt: new Date('2028-01-20'), uploadedBy: 'ebright@example.com', dueDate: new Date('2028-01-25'), signatures: [
    { id: 'abc-sig-7', documentId: 'abc-doc-3', partyId: 'abc-cp-2', signatoryName: 'Emma Bright', signatoryTitle: 'Managing Director', status: 'signed', signedAt: new Date('2028-01-20') },
    { id: 'abc-sig-8', documentId: 'abc-doc-3', partyId: 'abc-cp-1', signatoryName: 'Alan Pierce', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-01-20') },
    { id: 'abc-sig-9', documentId: 'abc-doc-3', partyId: 'abc-cp-5', signatoryName: 'Craig Sutton', signatoryTitle: 'Partner', status: 'signed', signedAt: new Date('2028-01-20') },
  ], satisfiesConditionIds: ['abc-cond-3'] },
  { id: 'abc-doc-4', dealId: 'abc-acquisition', documentType: 'credit_agreement', title: 'Funds Flow Memorandum', fileName: 'ABC_Funds_Flow_Memo.pdf', fileType: 'application/pdf', storagePath: '/documents/abc-doc-4.pdf', status: 'pending', responsiblePartyId: 'abc-cp-2', uploadedAt: new Date('2028-02-05'), uploadedBy: 'ebright@example.com', dueDate: new Date('2028-02-14'), signatures: [], satisfiesConditionIds: ['abc-cond-5'] },
  // ── Security Documents ──
  { id: 'abc-doc-5', dealId: 'abc-acquisition', documentType: 'security', title: 'Security Agreement', fileName: 'ABC_Security_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/abc-doc-5.pdf', status: 'executed', responsiblePartyId: 'abc-cp-5', uploadedAt: new Date('2028-01-31'), uploadedBy: 'partner@example.com', dueDate: new Date('2028-02-12'), signatures: [
    { id: 'abc-sig-10', documentId: 'abc-doc-5', partyId: 'abc-cp-2', signatoryName: 'Emma Bright', signatoryTitle: 'Managing Director', status: 'signed', signedAt: new Date('2028-01-31') },
    { id: 'abc-sig-11', documentId: 'abc-doc-5', partyId: 'abc-cp-1', signatoryName: 'Alan Pierce', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-01-31') },
    { id: 'abc-sig-12', documentId: 'abc-doc-5', partyId: 'abc-cp-7', signatoryName: 'Martin Vale', signatoryTitle: 'General Counsel', status: 'signed', signedAt: new Date('2028-02-01') },
...
const abcClosingDeal: ClosingDeal = {
  ...
  facilityAmount: 150_000_000,
  currency: 'USD',
  targetClosingDate: new Date('2028-02-15'),
  status: 'closing',
};
...
const solarNegotiationParties: DealParty[] = [
  { id: 'solar-party-borrower', dealId: 'solar-demo', name: 'Coyote Mesa Project Co LLC', shortName: 'Borrower', role: 'borrower', partyType: 'borrower', primaryContact: { name: 'Victor Hale', email: 'vhale@example.com', phone: '+1 (602) 555-0100', title: 'Project Director' }, additionalContacts: [], counselPartyId: 'solar-party-carrington' },
  { id: 'solar-party-sponsor', dealId: 'solar-demo', name: 'Coyote Mesa Holdings LLC', shortName: 'Sponsor', role: 'borrower', partyType: 'borrower', primaryContact: { name: 'Rita Moss', email: 'rmoss@example.com', phone: '+1 (602) 555-0101', title: 'CFO' }, additionalContacts: [], counselPartyId: 'solar-party-carrington' },
  { id: 'solar-party-agent', dealId: 'solar-demo', name: 'AgriTrust Cooperative Bank', shortName: 'Agent', role: 'administrative_agent', partyType: 'agent', primaryContact: { name: 'Carl Bishop', email: 'cbishop@example.com', phone: '+1 (303) 555-0200', title: 'Managing Director' }, additionalContacts: [], counselPartyId: 'solar-party-thornbury' },
  { id: 'solar-party-taxequity', dealId: 'solar-demo', name: 'Cardinal Tax Equity Fund LP', shortName: 'Tax Equity', role: 'lender', partyType: 'tax_equity', primaryContact: { name: 'Helen Ward', email: 'hward@example.com', phone: '+1 (212) 555-0300', title: 'Partner' }, additionalContacts: [], counselPartyId: null },
  { id: 'solar-party-carrington', dealId: 'solar-demo', name: 'Carrington & Reese LLP', shortName: 'Carrington', role: 'borrower', partyType: 'law_firm', primaryContact: { name: 'Aaron Fields', email: 'aaron.fields@example.com', phone: '+1 (213) 555-0400', title: 'Partner' }, additionalContacts: [], counselPartyId: null },
  { id: 'solar-party-thornbury', dealId: 'solar-demo', name: 'Thornbury LLP', shortName: 'Thornbury', role: 'administrative_agent', partyType: 'law_firm', primaryContact: { name: 'Karen Pruitt', email: 'kpruitt@example.com', phone: '+1 (212) 555-0500', title: 'Partner' }, additionalContacts: [], counselPartyId: null },
];

const solarNegotiationVersions: DealVersion[] = [
  { id: 'solar-version-1', dealId: 'solar-demo', versionNumber: 1, versionLabel: "Lender's Initial Draft", creditLangCode: '// Solar - Lender Initial\nCOVENANT MinDSCR REQUIRES DSCR >= 1.35 TESTED QUARTERLY', createdBy: 'kpruitt@example.com', authorParty: 'Thornbury', createdAt: new Date('2027-11-01'), parentVersionId: null, status: 'superseded', generatedWordDoc: null, changeSummary: null },
  { id: 'solar-version-2', dealId: 'solar-demo', versionNumber: 2, versionLabel: "Sponsor's Markup", creditLangCode: '// Solar - Sponsor Markup\nCOVENANT MinDSCR REQUIRES DSCR >= 1.20 TESTED QUARTERLY\nDEGRADATION_SCHEDULE PanelDegradation ANNUAL_DEGRADATION 0.5', createdBy: 'aaron.fields@example.com', authorParty: 'Carrington', createdAt: new Date('2027-11-15'), parentVersionId: 'solar-version-1', status: 'superseded', generatedWordDoc: null, changeSummary: { versionFrom: 1, versionTo: 2, authorParty: 'Carrington', createdAt: new Date('2027-11-15'), totalChanges: 2, covenantChanges: 1, definitionChanges: 0, basketChanges: 0, otherChanges: 1, borrowerFavorable: 2, lenderFavorable: 0, neutral: 0, changes: [
  ...
  { id: 'solar-version-3', dealId: 'solar-demo', versionNumber: 3, versionLabel: 'Agreed Terms', creditLangCode: solarCode, createdBy: 'kpruitt@example.com', authorParty: 'Thornbury', createdAt: new Date('2027-12-01'), parentVersionId: 'solar-version-2', status: 'draft', generatedWordDoc: null, changeSummary: { versionFrom: 2, versionTo: 3, authorParty: 'Thornbury', createdAt: new Date('2027-12-01'), totalChanges: 1, covenantChanges: 1, definitionChanges: 0, basketChanges: 0, otherChanges: 0, borrowerFavorable: 0, lenderFavorable: 1, neutral: 0, changes: [
...
const solarNegotiationDeal: Deal = {
  id: 'solar-demo', name: 'Coyote Mesa Solar Project', dealType: 'project_finance', facilityAmount: 280_000_000, currency: 'USD', status: 'negotiation', currentVersionId: 'solar-version-3', parties: solarNegotiationParties, targetClosingDate: new Date('2028-03-01'), actualClosingDate: null, maturityDate: new Date('2048-06-30'), createdAt: new Date('2027-10-15'), updatedAt: new Date('2027-12-01'), createdBy: 'cbishop@example.com',
};

const solarClosingParties: ClosingParty[] = [
  { id: 'solar-cp-1', dealId: 'solar-demo', name: 'Coyote Mesa Project Co LLC', shortName: 'Borrower', role: 'borrower', partyType: 'borrower' },
  { id: 'solar-cp-2', dealId: 'solar-demo', name: 'AgriTrust Cooperative Bank', shortName: 'Agent', role: 'administrative_agent', partyType: 'agent' },
  { id: 'solar-cp-3', dealId: 'solar-demo', name: 'Cardinal Tax Equity Fund LP', shortName: 'Tax Equity', role: 'lender', partyType: 'tax_equity' },
  { id: 'solar-cp-4', dealId: 'solar-demo', name: 'Carrington & Reese', shortName: 'Borrower Counsel', role: 'counsel', partyType: 'law_firm' },
  { id: 'solar-cp-5', dealId: 'solar-demo', name: 'Thornbury', shortName: 'Agent Counsel', role: 'counsel', partyType: 'law_firm' },
  { id: 'solar-cp-6', dealId: 'solar-demo', name: 'Vantage Solar EPC LLC', shortName: 'EPC Contractor', role: 'contractor', partyType: 'consultant' },
  { id: 'solar-cp-7', dealId: 'solar-demo', name: 'Broadmoor Engineering', shortName: 'Indep. Engineer', role: 'consultant', partyType: 'consultant' },
  { id: 'solar-cp-8', dealId: 'solar-demo', name: 'Sonora State Power', shortName: 'Offtaker/Utility', role: 'offtaker', partyType: 'offtaker' },
  { id: 'solar-cp-9', dealId: 'solar-demo', name: 'Crestline Energy Services', shortName: 'O&M Provider', role: 'contractor', partyType: 'consultant' },
];

const solarClosingConditions: ConditionPrecedent[] = [
  // ── Credit Agreement (4) ──
  { id: 'solar-cond-1', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(a)(i)', category: 'credit_agreement', title: 'Credit Agreement Execution', description: 'Fully executed Credit Agreement among Borrower, Lenders, and Administrative Agent', responsiblePartyId: 'solar-cp-4', status: 'pending', dueDate: new Date('2028-03-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Final form under review' },
  { id: 'solar-cond-2', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(a)(ii)', category: 'credit_agreement', title: 'Depositary Agreement', description: 'Executed Depositary Agreement establishing project revenue and reserve accounts', responsiblePartyId: 'solar-cp-2', status: 'pending', dueDate: new Date('2028-02-28'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Coordinating with depositary bank' },
  { id: 'solar-cond-3', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(a)(iii)', category: 'credit_agreement', title: 'Collateral Agency Agreement', description: 'Executed Collateral Agency Agreement appointing collateral agent for secured parties', responsiblePartyId: 'solar-cp-5', status: 'pending', dueDate: new Date('2028-03-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-4', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(a)(iv)', category: 'credit_agreement', title: 'Intercreditor Agreement', description: 'Executed Intercreditor Agreement among Senior Lenders and Tax Equity Investor', responsiblePartyId: 'solar-cp-5', status: 'pending', dueDate: new Date('2028-03-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Tax equity counsel reviewing' },
  // ── Security Documents (5) ──
  { id: 'solar-cond-5', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(b)(i)', category: 'security_documents', title: 'Security Agreement', description: 'Security Agreement granting first-priority security interest in all project assets', responsiblePartyId: 'solar-cp-4', status: 'satisfied', dueDate: new Date('2028-02-20'), satisfiedAt: new Date('2028-02-10'), satisfiedByDocumentIds: ['solar-doc-5'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-6', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(b)(ii)', category: 'security_documents', title: 'Pledge Agreement', description: 'Pledge of 100% of membership interests in Borrower by Sponsor', responsiblePartyId: 'solar-cp-4', status: 'satisfied', dueDate: new Date('2028-02-20'), satisfiedAt: new Date('2028-02-10'), satisfiedByDocumentIds: ['solar-doc-6'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-7', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(b)(iii)', category: 'security_documents', title: 'Mortgage/Deed of Trust', description: 'Mortgage over project site real property (640 acres, Maricopa County)', responsiblePartyId: 'solar-cp-4', status: 'pending', dueDate: new Date('2028-02-28'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Local counsel preparing' },
  { id: 'solar-cond-8', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(b)(iv)', category: 'security_documents', title: 'Assignment of Project Contracts', description: 'Collateral assignment of EPC Contract, O&M Agreement, PPA, and Interconnection Agreement', responsiblePartyId: 'solar-cp-4', status: 'pending', dueDate: new Date('2028-02-28'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Counterparty consents required' },
  ...
  { id: 'solar-cond-10', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(c)(i)', category: 'corporate_documents', title: 'Certificate of Formation', description: 'Certified copy of the Certificate of Formation of Coyote Mesa Project Co LLC from Delaware', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-02-01'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-11', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(c)(ii)', category: 'corporate_documents', title: 'LLC Agreement', description: 'Certified copy of the Amended and Restated LLC Agreement of the Borrower', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-02-01'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-12', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(c)(iii)', category: 'corporate_documents', title: "Officer's Certificate", description: 'Certificate of authorized officer certifying incumbency, resolutions, and no default', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-20'), satisfiedAt: new Date('2028-02-08'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-13', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(c)(iv)', category: 'corporate_documents', title: 'Good Standing Certificate (DE)', description: 'Certificate of Good Standing from Delaware Secretary of State', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-20'), satisfiedAt: new Date('2028-02-05'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Legal Opinions (3) ──
  { id: 'solar-cond-14', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(d)(i)', category: 'legal_opinions', title: 'Borrower Counsel Opinion', description: 'Legal opinion of Carrington & Reese covering enforceability, authorization, and no conflicts', responsiblePartyId: 'solar-cp-4', status: 'pending', dueDate: new Date('2028-02-28'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Draft in preparation' },
  { id: 'solar-cond-15', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(d)(ii)', category: 'legal_opinions', title: 'Agent Counsel Opinion', description: 'Legal opinion of Thornbury covering perfection and priority of security interests', responsiblePartyId: 'solar-cp-5', status: 'pending', dueDate: new Date('2028-02-28'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-16', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(d)(iii)', category: 'legal_opinions', title: 'Regulatory Counsel Opinion', description: 'Opinion of regulatory counsel confirming compliance with Arizona utility and energy regulations', responsiblePartyId: 'solar-cp-4', status: 'pending', dueDate: new Date('2028-02-28'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Engaging local Arizona counsel' },
  // ── Certificates (4) ──
  { id: 'solar-cond-17', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(e)(i)', category: 'certificates', title: 'Closing Certificate', description: 'Borrower closing certificate certifying representations, no default, and satisfaction of conditions', responsiblePartyId: 'solar-cp-1', status: 'pending', dueDate: new Date('2028-03-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'To be delivered at closing' },
  { id: 'solar-cond-18', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(e)(ii)', category: 'certificates', title: 'Solvency Certificate', description: 'Certificate from CFO as to solvency of the Borrower', responsiblePartyId: 'solar-cp-1', status: 'pending', dueDate: new Date('2028-03-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-19', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(e)(iii)', category: 'certificates', title: 'Independent Engineer Certificate', description: "Independent Engineer's certificate confirming feasibility and technical design adequacy", responsiblePartyId: 'solar-cp-7', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-02-05'), satisfiedByDocumentIds: ['solar-doc-9'], waivedAt: null, waiverApprovedBy: null, notes: 'Broadmoor IE report delivered' },
  { id: 'solar-cond-20', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(e)(iv)', category: 'certificates', title: 'Insurance Consultant Report', description: 'Insurance consultant report confirming adequacy of insurance program', responsiblePartyId: 'solar-cp-2', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-02-03'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Financial (3) ──
  { id: 'solar-cond-21', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(f)(i)', category: 'financial', title: 'Financial Model (Base Case)', description: 'Board-approved base case financial model with Agent-agreed assumptions', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-02-01'), satisfiedByDocumentIds: ['solar-doc-10'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-22', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(f)(ii)', category: 'financial', title: 'Construction Budget', description: 'Detailed construction budget approved by Independent Engineer', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-02-02'), satisfiedByDocumentIds: ['solar-doc-11'], waivedAt: null, waiverApprovedBy: null, notes: '$268M hard costs + $12M soft costs' },
  { id: 'solar-cond-23', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(f)(iii)', category: 'financial', title: 'Drawdown Schedule', description: 'Initial drawdown schedule consistent with construction schedule', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-02-02'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Insurance (3) ──
  ...
  { id: 'solar-cond-25', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(g)(ii)', category: 'insurance', title: 'Commercial General Liability', description: 'CGL insurance with $5M per occurrence / $10M aggregate, Agent as additional insured', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-02-01'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-26', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(g)(iii)', category: 'insurance', title: "Contractor's All-Risk", description: "EPC contractor's all-risk policy with Borrower and Agent named as additional insured", responsiblePartyId: 'solar-cp-6', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-02-03'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Permits (5) ──
  { id: 'solar-cond-27', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(h)(i)', category: 'permits', title: 'Conditional Use Permit', description: 'Conditional Use Permit from Maricopa County for utility-scale solar development', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-01'), satisfiedAt: new Date('2028-01-10'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Approved by County Board' },
  { id: 'solar-cond-28', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(h)(ii)', category: 'permits', title: 'NEPA/Environmental Clearance', description: 'National Environmental Policy Act clearance or categorical exclusion', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-01'), satisfiedAt: new Date('2028-01-10'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Categorical exclusion granted' },
  { id: 'solar-cond-29', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(h)(iii)', category: 'permits', title: 'Interconnection Approval', description: 'FERC-approved Large Generator Interconnection Agreement', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-20'), satisfiedAt: new Date('2028-01-25'), satisfiedByDocumentIds: ['solar-doc-12'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-30', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(h)(iv)', category: 'permits', title: 'State Utility Commission Approval', description: 'Sonora State Utility Commission approval of the PPA', responsiblePartyId: 'solar-cp-1', status: 'pending', dueDate: new Date('2028-02-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'OVERDUE — hearing rescheduled to Feb 10' },
  { id: 'solar-cond-31', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(h)(v)', category: 'permits', title: 'County Building Permits', description: 'Building permits for racking, inverter pads, and substation from Maricopa County', responsiblePartyId: 'solar-cp-1', status: 'pending', dueDate: new Date('2028-02-25'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Application submitted, review in progress' },
  // ── Technical (4) ──
  { id: 'solar-cond-32', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(i)(i)', category: 'technical', title: 'EPC Contract (Executed)', description: 'Fully executed EPC Contract with Vantage Solar EPC LLC for turnkey construction', responsiblePartyId: 'solar-cp-6', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-01-15'), satisfiedByDocumentIds: ['solar-doc-13'], waivedAt: null, waiverApprovedBy: null, notes: 'Fixed-price $245M, 18-month schedule' },
  { id: 'solar-cond-33', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(i)(ii)', category: 'technical', title: 'Independent Engineer Report', description: 'Independent Engineer feasibility report covering design, technology, and construction risk', responsiblePartyId: 'solar-cp-7', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-02-05'), satisfiedByDocumentIds: ['solar-doc-9'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-34', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(i)(iii)', category: 'technical', title: 'Geotechnical Study', description: 'Geotechnical study confirming soil conditions suitable for pile-driven racking', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-01-31'), satisfiedAt: new Date('2028-01-15'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-35', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(i)(iv)', category: 'technical', title: 'Electrical Design Package', description: '100% electrical design package reviewed and approved by Independent Engineer', responsiblePartyId: 'solar-cp-6', status: 'pending', dueDate: new Date('2028-02-28'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '90% design submitted, final comments outstanding' },
  // ── Tax Equity (4) ──
  { id: 'solar-cond-36', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(j)(i)', category: 'tax_equity', title: 'Tax Equity Partnership Agreement', description: 'Executed Amended and Restated LLC Agreement establishing partnership flip structure', responsiblePartyId: 'solar-cp-3', status: 'pending', dueDate: new Date('2028-02-28'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Final diligence ongoing — ITC qualification review' },
  { id: 'solar-cond-37', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(j)(ii)', category: 'tax_equity', title: 'Tax Opinion (ITC Qualification)', description: 'Tax opinion from nationally recognized tax counsel confirming ITC eligibility', responsiblePartyId: 'solar-cp-4', status: 'pending', dueDate: new Date('2028-02-28'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Draft under review by tax equity counsel' },
  { id: 'solar-cond-38', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(j)(iii)', category: 'tax_equity', title: 'ITC Qualification Letter', description: 'Engineer letter confirming project qualifies for Investment Tax Credit under IRC Section 48', responsiblePartyId: 'solar-cp-7', status: 'pending', dueDate: new Date('2028-02-25'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Broadmoor preparing based on 100% design' },
  { id: 'solar-cond-39', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(j)(iv)', category: 'tax_equity', title: 'Allocation Schedule', description: 'Tax credit and cash allocation schedule agreed between Sponsor and Tax Equity Investor', responsiblePartyId: 'solar-cp-3', status: 'pending', dueDate: new Date('2028-02-28'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '99/1 pre-flip, 5/95 post-flip proposed' },
  // ── Offtake (3) ──
  { id: 'solar-cond-40', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(k)(i)', category: 'offtake', title: 'Power Purchase Agreement (PPA)', description: 'Executed 25-year PPA with Sonora State Power at $42/MWh escalating 1.5% annually', responsiblePartyId: 'solar-cp-8', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-01-20'), satisfiedByDocumentIds: ['solar-doc-14'], waivedAt: null, waiverApprovedBy: null, notes: '25-year term with investment-grade offtaker' },
  { id: 'solar-cond-41', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(k)(ii)', category: 'offtake', title: 'Interconnection Agreement', description: 'Executed Large Generator Interconnection Agreement with transmission provider', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-20'), satisfiedAt: new Date('2028-01-25'), satisfiedByDocumentIds: ['solar-doc-12'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'solar-cond-42', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(k)(iii)', category: 'offtake', title: 'REC Purchase Agreement', description: 'Executed Renewable Energy Certificate purchase agreement', responsiblePartyId: 'solar-cp-1', status: 'satisfied', dueDate: new Date('2028-02-15'), satisfiedAt: new Date('2028-01-28'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Consents (3) ──
  { id: 'solar-cond-43', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(l)(i)', category: 'consents', title: 'Offtaker Consent (Utility)', description: 'Consent of Sonora State Power to collateral assignment of PPA to Collateral Agent', responsiblePartyId: 'solar-cp-8', status: 'pending', dueDate: new Date('2028-02-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'OVERDUE — utility legal department reviewing' },
  { id: 'solar-cond-44', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(l)(ii)', category: 'consents', title: 'EPC Contractor Consent', description: 'Consent of Vantage Solar EPC to collateral assignment of EPC Contract to Collateral Agent', responsiblePartyId: 'solar-cp-6', status: 'pending', dueDate: new Date('2028-02-25'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Vantage Solar legal reviewing form' },
  { id: 'solar-cond-45', dealId: 'solar-demo', versionId: 'solar-version-3', sectionReference: '4.01(l)(iii)', category: 'consents', title: 'O&M Provider Consent', description: 'Consent of Crestline Energy Services to collateral assignment of O&M Agreement', responsiblePartyId: 'solar-cp-9', status: 'pending', dueDate: new Date('2028-02-25'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
];

const solarClosingDocuments: ClosingDocument[] = [
  // ── Credit Agreement Documents ──
  { id: 'solar-doc-1', dealId: 'solar-demo', documentType: 'credit_agreement', title: 'Credit Agreement', fileName: 'CoyoteMesa_Credit_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-1.pdf', status: 'pending', responsiblePartyId: 'solar-cp-4', uploadedAt: new Date('2028-02-10'), uploadedBy: 'aaron.fields@example.com', dueDate: new Date('2028-03-01'), signatures: [
    { id: 'solar-sig-1', documentId: 'solar-doc-1', partyId: 'solar-cp-1', signatoryName: 'Victor Hale', signatoryTitle: 'Project Director', status: 'pending', signedAt: null },
    { id: 'solar-sig-2', documentId: 'solar-doc-1', partyId: 'solar-cp-2', signatoryName: 'Carl Bishop', signatoryTitle: 'Managing Director', status: 'pending', signedAt: null },
  ], satisfiesConditionIds: ['solar-cond-1'] },
  { id: 'solar-doc-2', dealId: 'solar-demo', documentType: 'credit_agreement', title: 'Depositary Agreement', fileName: 'CoyoteMesa_Depositary_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-2.pdf', status: 'pending', responsiblePartyId: 'solar-cp-2', uploadedAt: new Date('2028-02-08'), uploadedBy: 'cbishop@example.com', dueDate: new Date('2028-02-28'), signatures: [], satisfiesConditionIds: ['solar-cond-2'] },
  { id: 'solar-doc-3', dealId: 'solar-demo', documentType: 'credit_agreement', title: 'Collateral Agency Agreement', fileName: 'CoyoteMesa_Collateral_Agency.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-3.pdf', status: 'pending', responsiblePartyId: 'solar-cp-5', uploadedAt: new Date('2028-02-08'), uploadedBy: 'kpruitt@example.com', dueDate: new Date('2028-03-01'), signatures: [], satisfiesConditionIds: ['solar-cond-3'] },
  { id: 'solar-doc-4', dealId: 'solar-demo', documentType: 'credit_agreement', title: 'Intercreditor Agreement', fileName: 'CoyoteMesa_Intercreditor.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-4.pdf', status: 'pending', responsiblePartyId: 'solar-cp-5', uploadedAt: new Date('2028-02-10'), uploadedBy: 'kpruitt@example.com', dueDate: new Date('2028-03-01'), signatures: [], satisfiesConditionIds: ['solar-cond-4'] },
  // ── Security Documents ──
  { id: 'solar-doc-5', dealId: 'solar-demo', documentType: 'security', title: 'Security Agreement', fileName: 'CoyoteMesa_Security_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-5.pdf', status: 'executed', responsiblePartyId: 'solar-cp-4', uploadedAt: new Date('2028-02-10'), uploadedBy: 'aaron.fields@example.com', dueDate: new Date('2028-02-20'), signatures: [
    { id: 'solar-sig-3', documentId: 'solar-doc-5', partyId: 'solar-cp-1', signatoryName: 'Victor Hale', signatoryTitle: 'Project Director', status: 'signed', signedAt: new Date('2028-02-10') },
    { id: 'solar-sig-4', documentId: 'solar-doc-5', partyId: 'solar-cp-2', signatoryName: 'Carl Bishop', signatoryTitle: 'Managing Director', status: 'signed', signedAt: new Date('2028-02-10') },
  ], satisfiesConditionIds: ['solar-cond-5'] },
  { id: 'solar-doc-6', dealId: 'solar-demo', documentType: 'security', title: 'Pledge Agreement', fileName: 'CoyoteMesa_Pledge_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-6.pdf', status: 'executed', responsiblePartyId: 'solar-cp-4', uploadedAt: new Date('2028-02-10'), uploadedBy: 'aaron.fields@example.com', dueDate: new Date('2028-02-20'), signatures: [
    { id: 'solar-sig-5', documentId: 'solar-doc-6', partyId: 'solar-cp-1', signatoryName: 'Rita Moss', signatoryTitle: 'CFO, Sponsor', status: 'signed', signedAt: new Date('2028-02-10') },
  ], satisfiesConditionIds: ['solar-cond-6'] },
  { id: 'solar-doc-7', dealId: 'solar-demo', documentType: 'security', title: 'Mortgage/Deed of Trust', fileName: 'CoyoteMesa_Mortgage.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-7.pdf', status: 'pending', responsiblePartyId: 'solar-cp-4', uploadedAt: new Date('2028-02-12'), uploadedBy: 'aaron.fields@example.com', dueDate: new Date('2028-02-28'), signatures: [], satisfiesConditionIds: ['solar-cond-7'] },
  { id: 'solar-doc-8', dealId: 'solar-demo', documentType: 'security', title: 'Assignment of Project Contracts', fileName: 'CoyoteMesa_Contract_Assignment.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-8.pdf', status: 'pending', responsiblePartyId: 'solar-cp-4', uploadedAt: new Date('2028-02-12'), uploadedBy: 'aaron.fields@example.com', dueDate: new Date('2028-02-28'), signatures: [], satisfiesConditionIds: ['solar-cond-8'] },
  // ── Technical / IE ──
  { id: 'solar-doc-9', dealId: 'solar-demo', documentType: 'technical', title: 'Independent Engineer Report', fileName: 'CoyoteMesa_IE_Report_Broadmoor.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-9.pdf', status: 'uploaded', responsiblePartyId: 'solar-cp-7', uploadedAt: new Date('2028-02-05'), uploadedBy: 'engineer@example.com', dueDate: new Date('2028-02-15'), signatures: [], satisfiesConditionIds: ['solar-cond-19', 'solar-cond-33'] },
  // ── Financial Documents ──
  { id: 'solar-doc-10', dealId: 'solar-demo', documentType: 'financial', title: 'Financial Model (Base Case)', fileName: 'CoyoteMesa_Financial_Model.xlsx', fileType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', storagePath: '/documents/solar-doc-10.xlsx', status: 'uploaded', responsiblePartyId: 'solar-cp-1', uploadedAt: new Date('2028-02-01'), uploadedBy: 'vhale@example.com', dueDate: new Date('2028-02-15'), signatures: [], satisfiesConditionIds: ['solar-cond-21'] },
  { id: 'solar-doc-11', dealId: 'solar-demo', documentType: 'financial', title: 'Construction Budget', fileName: 'CoyoteMesa_Construction_Budget.xlsx', fileType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', storagePath: '/documents/solar-doc-11.xlsx', status: 'uploaded', responsiblePartyId: 'solar-cp-1', uploadedAt: new Date('2028-02-02'), uploadedBy: 'vhale@example.com', dueDate: new Date('2028-02-15'), signatures: [], satisfiesConditionIds: ['solar-cond-22'] },
  // ── Offtake / Interconnection ──
  { id: 'solar-doc-12', dealId: 'solar-demo', documentType: 'offtake', title: 'Interconnection Agreement', fileName: 'CoyoteMesa_LGIA.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-12.pdf', status: 'executed', responsiblePartyId: 'solar-cp-1', uploadedAt: new Date('2028-01-25'), uploadedBy: 'vhale@example.com', dueDate: new Date('2028-02-20'), signatures: [
    { id: 'solar-sig-6', documentId: 'solar-doc-12', partyId: 'solar-cp-1', signatoryName: 'Victor Hale', signatoryTitle: 'Project Director', status: 'signed', signedAt: new Date('2028-01-25') },
  ], satisfiesConditionIds: ['solar-cond-29', 'solar-cond-41'] },
  // ── EPC Contract ──
  { id: 'solar-doc-13', dealId: 'solar-demo', documentType: 'technical', title: 'EPC Contract', fileName: 'CoyoteMesa_EPC_Contract.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-13.pdf', status: 'executed', responsiblePartyId: 'solar-cp-6', uploadedAt: new Date('2028-01-15'), uploadedBy: 'contracts@example.com', dueDate: new Date('2028-02-15'), signatures: [
    { id: 'solar-sig-7', documentId: 'solar-doc-13', partyId: 'solar-cp-1', signatoryName: 'Victor Hale', signatoryTitle: 'Project Director', status: 'signed', signedAt: new Date('2028-01-15') },
    { id: 'solar-sig-8', documentId: 'solar-doc-13', partyId: 'solar-cp-6', signatoryName: 'Philip Reed', signatoryTitle: 'VP, EPC Projects', status: 'signed', signedAt: new Date('2028-01-15') },
  ], satisfiesConditionIds: ['solar-cond-32'] },
  // ── PPA ──
  { id: 'solar-doc-14', dealId: 'solar-demo', documentType: 'offtake', title: 'Power Purchase Agreement (PPA)', fileName: 'CoyoteMesa_PPA.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-14.pdf', status: 'executed', responsiblePartyId: 'solar-cp-8', uploadedAt: new Date('2028-01-20'), uploadedBy: 'vhale@example.com', dueDate: new Date('2028-02-15'), signatures: [
    { id: 'solar-sig-9', documentId: 'solar-doc-14', partyId: 'solar-cp-1', signatoryName: 'Victor Hale', signatoryTitle: 'Project Director', status: 'signed', signedAt: new Date('2028-01-20') },
    { id: 'solar-sig-10', documentId: 'solar-doc-14', partyId: 'solar-cp-8', signatoryName: 'Grace Tran', signatoryTitle: 'VP, Power Supply', status: 'signed', signedAt: new Date('2028-01-20') },
  ], satisfiesConditionIds: ['solar-cond-40'] },
  // ── Tax Equity Partnership ──
  { id: 'solar-doc-15', dealId: 'solar-demo', documentType: 'tax_equity', title: 'Tax Equity Partnership Agreement (Draft)', fileName: 'CoyoteMesa_TEPA_Draft.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-15.pdf', status: 'pending', responsiblePartyId: 'solar-cp-3', uploadedAt: new Date('2028-02-08'), uploadedBy: 'hward@example.com', dueDate: new Date('2028-02-28'), signatures: [
    { id: 'solar-sig-11', documentId: 'solar-doc-15', partyId: 'solar-cp-1', signatoryName: 'Rita Moss', signatoryTitle: 'CFO, Sponsor', status: 'pending', signedAt: null },
    { id: 'solar-sig-12', documentId: 'solar-doc-15', partyId: 'solar-cp-3', signatoryName: 'Helen Ward', signatoryTitle: 'Partner', status: 'pending', signedAt: null },
  ], satisfiesConditionIds: ['solar-cond-36'] },
  // ── Geotechnical ──
  { id: 'solar-doc-16', dealId: 'solar-demo', documentType: 'technical', title: 'Geotechnical Study', fileName: 'CoyoteMesa_Geotech_Report.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-16.pdf', status: 'uploaded', responsiblePartyId: 'solar-cp-1', uploadedAt: new Date('2028-01-15'), uploadedBy: 'vhale@example.com', dueDate: new Date('2028-01-31'), signatures: [], satisfiesConditionIds: ['solar-cond-34'] },
  // ── Corporate ──
  { id: 'solar-doc-17', dealId: 'solar-demo', documentType: 'corporate', title: "Officer's Certificate", fileName: 'CoyoteMesa_Officers_Certificate.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-17.pdf', status: 'uploaded', responsiblePartyId: 'solar-cp-1', uploadedAt: new Date('2028-02-08'), uploadedBy: 'vhale@example.com', dueDate: new Date('2028-02-20'), signatures: [], satisfiesConditionIds: ['solar-cond-12'] },
  // ── Insurance ──
  { id: 'solar-doc-18', dealId: 'solar-demo', documentType: 'insurance', title: "Builder's Risk Insurance Certificate", fileName: 'CoyoteMesa_Builders_Risk.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-18.pdf', status: 'uploaded', responsiblePartyId: 'solar-cp-1', uploadedAt: new Date('2028-02-01'), uploadedBy: 'admin@example.com', dueDate: new Date('2028-02-15'), signatures: [], satisfiesConditionIds: ['solar-cond-24'] },
  // ── REC Agreement ──
  { id: 'solar-doc-19', dealId: 'solar-demo', documentType: 'offtake', title: 'REC Purchase Agreement', fileName: 'CoyoteMesa_REC_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/solar-doc-19.pdf', status: 'uploaded', responsiblePartyId: 'solar-cp-1', uploadedAt: new Date('2028-01-28'), uploadedBy: 'vhale@example.com', dueDate: new Date('2028-02-15'), signatures: [], satisfiesConditionIds: ['solar-cond-42'] },
];

const solarClosingDeal: ClosingDeal = { id: 'solar-demo', name: 'Coyote Mesa Solar Project', facilityAmount: 280_000_000, currency: 'USD', targetClosingDate: new Date('2028-03-01'), status: 'closing' };
...
const windNegotiationParties: DealParty[] = [
  { id: 'wind-party-borrower', dealId: 'wind-demo', name: 'Ridgeline Wind Holdings LLC', shortName: 'Borrower', role: 'borrower', partyType: 'borrower', primaryContact: { name: 'Gregory Dunn', email: 'gdunn@example.com', phone: '+1 (405) 555-0100', title: 'CEO' }, additionalContacts: [], counselPartyId: 'wind-party-ashcroft' },
  { id: 'wind-party-agent', dealId: 'wind-demo', name: 'Keystone Global Bank', shortName: 'Agent', role: 'administrative_agent', partyType: 'agent', primaryContact: { name: 'Grace Okada', email: 'gokada@example.com', phone: '+1 (212) 555-0200', title: 'Director' }, additionalContacts: [], counselPartyId: 'wind-party-paulweiss' },
  { id: 'wind-party-ashcroft', dealId: 'wind-demo', name: 'Ashcroft & Lund LLP', shortName: 'Ashcroft', role: 'borrower', partyType: 'law_firm', primaryContact: { name: 'Daniel Reyes', email: 'dreyes@example.com', phone: '+1 (312) 555-0400', title: 'Partner' }, additionalContacts: [], counselPartyId: null },
  { id: 'wind-party-paulweiss', dealId: 'wind-demo', name: 'Halloran LLP', shortName: 'Halloran', role: 'administrative_agent', partyType: 'law_firm', primaryContact: { name: 'Nina Alvarez', email: 'nalvarez@example.com', phone: '+1 (212) 555-0500', title: 'Partner' }, additionalContacts: [], counselPartyId: null },
];

const windNegotiationVersions: DealVersion[] = [
  { id: 'wind-version-1', dealId: 'wind-demo', versionNumber: 1, versionLabel: "Lender's Initial Draft", creditLangCode: '// Wind - Lender Initial\nCOVENANT MinDSCR REQUIRES DSCR >= 1.40', createdBy: 'nalvarez@example.com', authorParty: 'Halloran', createdAt: new Date('2027-10-01'), parentVersionId: null, status: 'superseded', generatedWordDoc: null, changeSummary: null },
  { id: 'wind-version-2', dealId: 'wind-demo', versionNumber: 2, versionLabel: "Sponsor's Markup", creditLangCode: '// Wind - Sponsor Markup\nCOVENANT MinDSCR REQUIRES DSCR >= 1.25\nCOVENANT CurtailmentLimit REQUIRES curtailment_pct <= 7.0', createdBy: 'dreyes@example.com', authorParty: 'Ashcroft', createdAt: new Date('2027-10-20'), parentVersionId: 'wind-version-1', status: 'superseded', generatedWordDoc: null, changeSummary: { versionFrom: 1, versionTo: 2, authorParty: 'Ashcroft', createdAt: new Date('2027-10-20'), totalChanges: 2, covenantChanges: 2, definitionChanges: 0, basketChanges: 0, otherChanges: 0, borrowerFavorable: 2, lenderFavorable: 0, neutral: 0, changes: [
  ...
  { id: 'wind-version-3', dealId: 'wind-demo', versionNumber: 3, versionLabel: 'Agreed Terms', creditLangCode: windCode, createdBy: 'nalvarez@example.com', authorParty: 'Halloran', createdAt: new Date('2027-11-15'), parentVersionId: 'wind-version-2', status: 'draft', generatedWordDoc: null, changeSummary: { versionFrom: 2, versionTo: 3, authorParty: 'Halloran', createdAt: new Date('2027-11-15'), totalChanges: 1, covenantChanges: 1, definitionChanges: 0, basketChanges: 0, otherChanges: 0, borrowerFavorable: 0, lenderFavorable: 1, neutral: 0, changes: [
...
const windNegotiationDeal: Deal = {
  id: 'wind-demo', name: 'Ridgeline Wind Farm', dealType: 'project_finance', facilityAmount: 320_000_000, currency: 'USD', status: 'negotiation', currentVersionId: 'wind-version-3', parties: windNegotiationParties, targetClosingDate: new Date('2028-02-20'), actualClosingDate: null, maturityDate: new Date('2043-03-31'), createdAt: new Date('2027-09-15'), updatedAt: new Date('2027-11-15'), createdBy: 'gokada@example.com',
};

const windClosingParties: ClosingParty[] = [
  { id: 'wind-cp-1', dealId: 'wind-demo', name: 'Ridgeline Wind Holdings LLC', shortName: 'Borrower', role: 'borrower', partyType: 'borrower' },
  { id: 'wind-cp-2', dealId: 'wind-demo', name: 'Keystone Global Bank', shortName: 'Agent', role: 'administrative_agent', partyType: 'agent' },
  { id: 'wind-cp-3', dealId: 'wind-demo', name: 'Ashcroft & Lund', shortName: 'Borrower Counsel', role: 'counsel', partyType: 'law_firm' },
  { id: 'wind-cp-4', dealId: 'wind-demo', name: 'Halloran', shortName: 'Agent Counsel', role: 'counsel', partyType: 'law_firm' },
  { id: 'wind-cp-5', dealId: 'wind-demo', name: 'Galewind Turbine Systems', shortName: 'Turbine OEM', role: 'contractor', partyType: 'consultant' },
  { id: 'wind-cp-6', dealId: 'wind-demo', name: 'Sterling Independent Engineers', shortName: 'Indep. Engineer', role: 'consultant', partyType: 'consultant' },
  { id: 'wind-cp-7', dealId: 'wind-demo', name: 'Frontier Electric Cooperative', shortName: 'Offtaker', role: 'offtaker', partyType: 'offtaker' },
];

const windClosingConditions: ConditionPrecedent[] = [
  // ── Credit Agreement (3) ──
  { id: 'wind-cond-1', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(a)(i)', category: 'credit_agreement', title: 'Credit Agreement Execution', description: 'Fully executed Credit Agreement among Borrower, Lenders, and Administrative Agent', responsiblePartyId: 'wind-cp-3', status: 'pending', dueDate: new Date('2028-02-20'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Final form circulated' },
  { id: 'wind-cond-2', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(a)(ii)', category: 'credit_agreement', title: 'Depositary Agreement', description: 'Executed Depositary Agreement establishing project revenue and reserve accounts', responsiblePartyId: 'wind-cp-2', status: 'pending', dueDate: new Date('2028-02-18'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Depositary bank engaged' },
  { id: 'wind-cond-3', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(a)(iii)', category: 'credit_agreement', title: 'Collateral Agency Agreement', description: 'Executed Collateral Agency Agreement appointing collateral agent', responsiblePartyId: 'wind-cp-4', status: 'pending', dueDate: new Date('2028-02-20'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Security Documents (4) ──
  { id: 'wind-cond-4', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(b)(i)', category: 'security_documents', title: 'Security Agreement', description: 'Security Agreement granting first-priority security interest in all project assets', responsiblePartyId: 'wind-cp-3', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-02-05'), satisfiedByDocumentIds: ['wind-doc-4'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-5', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(b)(ii)', category: 'security_documents', title: 'Pledge Agreement', description: 'Pledge of 100% of membership interests in Borrower by Sponsor', responsiblePartyId: 'wind-cp-3', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-02-05'), satisfiedByDocumentIds: ['wind-doc-5'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-6', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(b)(iii)', category: 'security_documents', title: 'Mortgage/Deed of Trust', description: 'Mortgage over project site real property (12,000 acres, multiple parcels, Oklahoma)', responsiblePartyId: 'wind-cp-3', status: 'pending', dueDate: new Date('2028-02-18'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Local counsel finalizing legal descriptions' },
  { id: 'wind-cond-7', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(b)(iv)', category: 'security_documents', title: 'Assignment of Project Contracts', description: 'Collateral assignment of TSA, PPA, O&M Agreement, and Interconnection Agreement', responsiblePartyId: 'wind-cp-3', status: 'pending', dueDate: new Date('2028-02-18'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Counterparty consents required' },
  // ── Corporate Documents (4) ──
  { id: 'wind-cond-8', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(c)(i)', category: 'corporate_documents', title: 'Certificate of Formation', description: 'Certified copy of the Certificate of Formation of Ridgeline Wind Holdings LLC from Delaware', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-20'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-9', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(c)(ii)', category: 'corporate_documents', title: 'LLC Agreement', description: 'Certified copy of the Amended and Restated LLC Agreement of the Borrower', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-20'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-10', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(c)(iii)', category: 'corporate_documents', title: "Officer's Certificate", description: 'Certificate of authorized officer certifying incumbency, resolutions, and no default', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-02-03'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-11', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(c)(iv)', category: 'corporate_documents', title: 'Good Standing Certificate (DE)', description: 'Certificate of Good Standing from Delaware Secretary of State', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-01-28'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Legal Opinions (3) ──
  { id: 'wind-cond-12', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(d)(i)', category: 'legal_opinions', title: 'Borrower Counsel Opinion', description: 'Legal opinion of Ashcroft & Lund covering enforceability, authorization, and no conflicts', responsiblePartyId: 'wind-cp-3', status: 'pending', dueDate: new Date('2028-02-18'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Draft in preparation' },
  { id: 'wind-cond-13', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(d)(ii)', category: 'legal_opinions', title: 'Agent Counsel Opinion', description: 'Legal opinion of Halloran covering perfection and priority of security interests', responsiblePartyId: 'wind-cp-4', status: 'pending', dueDate: new Date('2028-02-18'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-14', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(d)(iii)', category: 'legal_opinions', title: 'Regulatory Counsel Opinion', description: 'Opinion of Oklahoma regulatory counsel on utility and energy regulatory compliance', responsiblePartyId: 'wind-cp-3', status: 'pending', dueDate: new Date('2028-02-18'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Engaging local Oklahoma counsel' },
  // ── Certificates (3) ──
  { id: 'wind-cond-15', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(e)(i)', category: 'certificates', title: 'Closing Certificate', description: 'Borrower closing certificate certifying representations, no default, and satisfaction of conditions', responsiblePartyId: 'wind-cp-1', status: 'pending', dueDate: new Date('2028-02-20'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'To be delivered at closing' },
  { id: 'wind-cond-16', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(e)(ii)', category: 'certificates', title: 'Solvency Certificate', description: 'Certificate from CFO as to solvency of the Borrower', responsiblePartyId: 'wind-cp-1', status: 'pending', dueDate: new Date('2028-02-20'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-17', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(e)(iii)', category: 'certificates', title: 'Independent Engineer Certificate', description: "Independent Engineer's certificate confirming feasibility and technical design adequacy", responsiblePartyId: 'wind-cp-6', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-01-28'), satisfiedByDocumentIds: ['wind-doc-7'], waivedAt: null, waiverApprovedBy: null, notes: 'Sterling IE IE report delivered' },
  // ── Financial (3) ──
  { id: 'wind-cond-18', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(f)(i)', category: 'financial', title: 'Financial Model (Base Case)', description: 'Board-approved base case financial model with Agent-agreed assumptions', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-25'), satisfiedByDocumentIds: ['wind-doc-8'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-19', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(f)(ii)', category: 'financial', title: 'Construction Budget', description: 'Detailed construction budget approved by Independent Engineer', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-25'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '$290M total project cost' },
  { id: 'wind-cond-20', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(f)(iii)', category: 'financial', title: 'Drawdown Schedule', description: 'Initial drawdown schedule consistent with construction schedule and turbine delivery dates', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-05'), satisfiedAt: new Date('2028-01-25'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Insurance (3) ──
  { id: 'wind-cond-21', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(g)(i)', category: 'insurance', title: "Builder's Risk Insurance", description: "Builder's all-risk insurance covering project during construction for full replacement value", responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-02-01'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-22', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(g)(ii)', category: 'insurance', title: 'Equipment Breakdown Insurance', description: 'Equipment breakdown coverage for turbines and electrical equipment during testing', responsiblePartyId: 'wind-cp-1', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Awaiting binder from broker' },
  { id: 'wind-cond-23', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(g)(iii)', category: 'insurance', title: 'Commercial General Liability', description: 'CGL insurance with $5M per occurrence / $10M aggregate, Agent as additional insured', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-02-01'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Permits (5) ──
  { id: 'wind-cond-24', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(h)(i)', category: 'permits', title: 'FAA Determination of No Hazard', description: 'FAA Determination of No Hazard to Air Navigation for all 36 turbine locations', responsiblePartyId: 'wind-cp-1', status: 'pending', dueDate: new Date('2028-02-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'OVERDUE — 32 of 36 determinations received, 4 pending re-study due to flight path revision' },
  { id: 'wind-cond-25', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(h)(ii)', category: 'permits', title: 'CUP/Zoning Approval', description: 'Conditional Use Permit from Garfield County, Oklahoma for wind energy development', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-01-15'), satisfiedAt: new Date('2028-01-05'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Approved unanimously by County Commission' },
  { id: 'wind-cond-26', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(h)(iii)', category: 'permits', title: 'NEPA Clearance', description: 'National Environmental Policy Act environmental assessment or categorical exclusion', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-01-31'), satisfiedAt: new Date('2028-01-15'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'EA with FONSI issued' },
  { id: 'wind-cond-27', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(h)(iv)', category: 'permits', title: 'State Utility Commission Approval', description: 'Midland State Utility Commission approval of power purchase structure', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-01'), satisfiedAt: new Date('2028-01-18'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-28', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(h)(v)', category: 'permits', title: 'Tribal Consultation Clearance', description: 'Completed Section 106 tribal consultation and clearance from relevant tribal nations', responsiblePartyId: 'wind-cp-1', status: 'pending', dueDate: new Date('2028-02-01'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'OVERDUE — final meeting with Osage Nation scheduled Feb 12' },
  // ── Technical (4) ──
  { id: 'wind-cond-29', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(i)(i)', category: 'technical', title: 'Turbine Supply Agreement', description: 'Fully executed Turbine Supply Agreement with Galewind for 36x V150-4.2 MW turbines', responsiblePartyId: 'wind-cp-5', status: 'satisfied', dueDate: new Date('2028-02-01'), satisfiedAt: new Date('2028-01-15'), satisfiedByDocumentIds: ['wind-doc-9'], waivedAt: null, waiverApprovedBy: null, notes: 'V150-4.2 MW, hub height 105m' },
  { id: 'wind-cond-30', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(i)(ii)', category: 'technical', title: 'Wind Resource Assessment (P50/P75/P90)', description: 'Independent wind resource assessment with at least 2 years of on-site met tower data', responsiblePartyId: 'wind-cp-6', status: 'satisfied', dueDate: new Date('2028-01-15'), satisfiedAt: new Date('2027-12-20'), satisfiedByDocumentIds: ['wind-doc-10'], waivedAt: null, waiverApprovedBy: null, notes: 'Sterling IE completed — P50: 525 GWh/yr, P90: 468 GWh/yr' },
  { id: 'wind-cond-31', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(i)(iii)', category: 'technical', title: 'Geotechnical Report', description: 'Geotechnical study confirming soil conditions suitable for turbine foundations', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-01-15'), satisfiedAt: new Date('2027-12-15'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-32', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(i)(iv)', category: 'technical', title: 'Foundation Design Package', description: 'Final foundation design approved by Independent Engineer for all 36 turbine locations', responsiblePartyId: 'wind-cp-1', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '32 of 36 locations approved, 4 pending revised geotech' },
  // ── Offtake (3) ──
  { id: 'wind-cond-33', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(j)(i)', category: 'offtake', title: 'PPA / Hedge Agreement', description: '15-year fixed-price hedge with investment-grade counterparty', responsiblePartyId: 'wind-cp-7', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-01-25'), satisfiedByDocumentIds: ['wind-doc-11'], waivedAt: null, waiverApprovedBy: null, notes: '15-year term at $38/MWh escalating 2%/yr' },
  { id: 'wind-cond-34', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(j)(ii)', category: 'offtake', title: 'Interconnection Agreement', description: 'Executed Large Generator Interconnection Agreement with SPP', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-01'), satisfiedAt: new Date('2028-01-10'), satisfiedByDocumentIds: ['wind-doc-12'], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-35', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(j)(iii)', category: 'offtake', title: 'REC Purchase Agreement', description: 'Executed Renewable Energy Certificate purchase agreement', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-02-10'), satisfiedAt: new Date('2028-01-28'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Consents (2) ──
  { id: 'wind-cond-36', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(k)(i)', category: 'consents', title: 'Turbine OEM Consent', description: 'Consent of Galewind to collateral assignment of Turbine Supply Agreement to Collateral Agent', responsiblePartyId: 'wind-cp-5', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Galewind legal reviewing form of consent' },
  { id: 'wind-cond-37', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(k)(ii)', category: 'consents', title: 'O&M Provider Consent', description: 'Consent of Galewind Service to collateral assignment of O&M Agreement', responsiblePartyId: 'wind-cp-5', status: 'pending', dueDate: new Date('2028-02-15'), satisfiedAt: null, satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  // ── Due Diligence (3) ──
  { id: 'wind-cond-38', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(l)(i)', category: 'due_diligence', title: 'Avian & Wildlife Study', description: 'Avian and bat mortality study conducted per USFWS guidelines covering at least 2 years of data', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-01-31'), satisfiedAt: new Date('2028-01-10'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'No significant impacts identified; eagle take permit not required' },
  { id: 'wind-cond-39', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(l)(ii)', category: 'due_diligence', title: 'Noise Impact Assessment', description: 'Noise propagation study confirming compliance with Oklahoma noise standards at all receptor locations', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-01-31'), satisfiedAt: new Date('2028-01-08'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'wind-cond-40', dealId: 'wind-demo', versionId: 'wind-version-3', sectionReference: '4.01(l)(iii)', category: 'due_diligence', title: 'Shadow Flicker Analysis', description: 'Shadow flicker analysis confirming less than 30 hours per year at all residential receptors', responsiblePartyId: 'wind-cp-1', status: 'satisfied', dueDate: new Date('2028-01-31'), satisfiedAt: new Date('2028-01-08'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: 'Max 18 hrs/yr at nearest receptor' },
];

const windClosingDocuments: ClosingDocument[] = [
  // ── Credit Agreement Documents ──
  { id: 'wind-doc-1', dealId: 'wind-demo', documentType: 'credit_agreement', title: 'Credit Agreement', fileName: 'Ridgeline_Credit_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-1.pdf', status: 'pending', responsiblePartyId: 'wind-cp-3', uploadedAt: new Date('2028-02-05'), uploadedBy: 'dreyes@example.com', dueDate: new Date('2028-02-20'), signatures: [
    { id: 'wind-sig-1', documentId: 'wind-doc-1', partyId: 'wind-cp-1', signatoryName: 'Gregory Dunn', signatoryTitle: 'CEO', status: 'pending', signedAt: null },
    { id: 'wind-sig-2', documentId: 'wind-doc-1', partyId: 'wind-cp-2', signatoryName: 'Grace Okada', signatoryTitle: 'Director', status: 'pending', signedAt: null },
  ], satisfiesConditionIds: ['wind-cond-1'] },
  { id: 'wind-doc-2', dealId: 'wind-demo', documentType: 'credit_agreement', title: 'Depositary Agreement', fileName: 'Ridgeline_Depositary.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-2.pdf', status: 'pending', responsiblePartyId: 'wind-cp-2', uploadedAt: new Date('2028-02-05'), uploadedBy: 'gokada@example.com', dueDate: new Date('2028-02-18'), signatures: [], satisfiesConditionIds: ['wind-cond-2'] },
  { id: 'wind-doc-3', dealId: 'wind-demo', documentType: 'credit_agreement', title: 'Collateral Agency Agreement', fileName: 'Ridgeline_Collateral_Agency.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-3.pdf', status: 'pending', responsiblePartyId: 'wind-cp-4', uploadedAt: new Date('2028-02-05'), uploadedBy: 'nalvarez@example.com', dueDate: new Date('2028-02-20'), signatures: [], satisfiesConditionIds: ['wind-cond-3'] },
  // ── Security Documents ──
  { id: 'wind-doc-4', dealId: 'wind-demo', documentType: 'security', title: 'Security Agreement', fileName: 'Ridgeline_Security_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-4.pdf', status: 'executed', responsiblePartyId: 'wind-cp-3', uploadedAt: new Date('2028-02-05'), uploadedBy: 'dreyes@example.com', dueDate: new Date('2028-02-10'), signatures: [
    { id: 'wind-sig-3', documentId: 'wind-doc-4', partyId: 'wind-cp-1', signatoryName: 'Gregory Dunn', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-02-05') },
    { id: 'wind-sig-4', documentId: 'wind-doc-4', partyId: 'wind-cp-2', signatoryName: 'Grace Okada', signatoryTitle: 'Director', status: 'signed', signedAt: new Date('2028-02-05') },
  ], satisfiesConditionIds: ['wind-cond-4'] },
  { id: 'wind-doc-5', dealId: 'wind-demo', documentType: 'security', title: 'Pledge Agreement', fileName: 'Ridgeline_Pledge_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-5.pdf', status: 'executed', responsiblePartyId: 'wind-cp-3', uploadedAt: new Date('2028-02-05'), uploadedBy: 'dreyes@example.com', dueDate: new Date('2028-02-10'), signatures: [
    { id: 'wind-sig-5', documentId: 'wind-doc-5', partyId: 'wind-cp-1', signatoryName: 'Gregory Dunn', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-02-05') },
  ], satisfiesConditionIds: ['wind-cond-5'] },
  { id: 'wind-doc-6', dealId: 'wind-demo', documentType: 'security', title: 'Mortgage/Deed of Trust', fileName: 'Ridgeline_Mortgage.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-6.pdf', status: 'pending', responsiblePartyId: 'wind-cp-3', uploadedAt: new Date('2028-02-08'), uploadedBy: 'dreyes@example.com', dueDate: new Date('2028-02-18'), signatures: [], satisfiesConditionIds: ['wind-cond-6'] },
  // ── Independent Engineer ──
  { id: 'wind-doc-7', dealId: 'wind-demo', documentType: 'technical', title: 'Independent Engineer Report', fileName: 'Ridgeline_IE_Report_SterlingIE.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-7.pdf', status: 'uploaded', responsiblePartyId: 'wind-cp-6', uploadedAt: new Date('2028-01-28'), uploadedBy: 'engineer@example.com', dueDate: new Date('2028-02-10'), signatures: [], satisfiesConditionIds: ['wind-cond-17'] },
  // ── Financial Model ──
  { id: 'wind-doc-8', dealId: 'wind-demo', documentType: 'financial', title: 'Financial Model (Base Case)', fileName: 'Ridgeline_Financial_Model.xlsx', fileType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', storagePath: '/documents/wind-doc-8.xlsx', status: 'uploaded', responsiblePartyId: 'wind-cp-1', uploadedAt: new Date('2028-01-25'), uploadedBy: 'gdunn@example.com', dueDate: new Date('2028-02-05'), signatures: [], satisfiesConditionIds: ['wind-cond-18'] },
  // ── Turbine Supply Agreement ──
  { id: 'wind-doc-9', dealId: 'wind-demo', documentType: 'technical', title: 'Turbine Supply Agreement', fileName: 'Ridgeline_TSA_Galewind.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-9.pdf', status: 'executed', responsiblePartyId: 'wind-cp-5', uploadedAt: new Date('2028-01-15'), uploadedBy: 'gdunn@example.com', dueDate: new Date('2028-02-01'), signatures: [
    { id: 'wind-sig-6', documentId: 'wind-doc-9', partyId: 'wind-cp-1', signatoryName: 'Gregory Dunn', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-01-15') },
    { id: 'wind-sig-7', documentId: 'wind-doc-9', partyId: 'wind-cp-5', signatoryName: 'Anders Holt', signatoryTitle: 'VP, Americas', status: 'signed', signedAt: new Date('2028-01-15') },
  ], satisfiesConditionIds: ['wind-cond-29'] },
  // ── Wind Resource Assessment ──
  { id: 'wind-doc-10', dealId: 'wind-demo', documentType: 'technical', title: 'Wind Resource Assessment (P50/P75/P90)', fileName: 'Ridgeline_Wind_Study_SterlingIE.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-10.pdf', status: 'uploaded', responsiblePartyId: 'wind-cp-6', uploadedAt: new Date('2027-12-20'), uploadedBy: 'engineer@example.com', dueDate: new Date('2028-01-15'), signatures: [], satisfiesConditionIds: ['wind-cond-30'] },
  // ── PPA / Hedge ──
  { id: 'wind-doc-11', dealId: 'wind-demo', documentType: 'offtake', title: 'PPA / Hedge Agreement', fileName: 'Ridgeline_Hedge_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-11.pdf', status: 'executed', responsiblePartyId: 'wind-cp-7', uploadedAt: new Date('2028-01-25'), uploadedBy: 'gdunn@example.com', dueDate: new Date('2028-02-10'), signatures: [
    { id: 'wind-sig-8', documentId: 'wind-doc-11', partyId: 'wind-cp-1', signatoryName: 'Gregory Dunn', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-01-25') },
    { id: 'wind-sig-9', documentId: 'wind-doc-11', partyId: 'wind-cp-7', signatoryName: 'Dean Marsh', signatoryTitle: 'VP, Power Supply', status: 'signed', signedAt: new Date('2028-01-25') },
  ], satisfiesConditionIds: ['wind-cond-33'] },
  // ── Interconnection Agreement ──
  { id: 'wind-doc-12', dealId: 'wind-demo', documentType: 'offtake', title: 'Interconnection Agreement', fileName: 'Ridgeline_LGIA_SPP.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-12.pdf', status: 'executed', responsiblePartyId: 'wind-cp-1', uploadedAt: new Date('2028-01-10'), uploadedBy: 'gdunn@example.com', dueDate: new Date('2028-02-01'), signatures: [
    { id: 'wind-sig-10', documentId: 'wind-doc-12', partyId: 'wind-cp-1', signatoryName: 'Gregory Dunn', signatoryTitle: 'CEO', status: 'signed', signedAt: new Date('2028-01-10') },
  ], satisfiesConditionIds: ['wind-cond-34'] },
  // ── Insurance ──
  { id: 'wind-doc-13', dealId: 'wind-demo', documentType: 'insurance', title: "Builder's Risk Insurance Certificate", fileName: 'Ridgeline_Builders_Risk.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-13.pdf', status: 'uploaded', responsiblePartyId: 'wind-cp-1', uploadedAt: new Date('2028-02-01'), uploadedBy: 'admin@example.com', dueDate: new Date('2028-02-10'), signatures: [], satisfiesConditionIds: ['wind-cond-21'] },
  // ── Corporate ──
  { id: 'wind-doc-14', dealId: 'wind-demo', documentType: 'corporate', title: "Officer's Certificate", fileName: 'Ridgeline_Officers_Certificate.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-14.pdf', status: 'uploaded', responsiblePartyId: 'wind-cp-1', uploadedAt: new Date('2028-02-03'), uploadedBy: 'gdunn@example.com', dueDate: new Date('2028-02-10'), signatures: [], satisfiesConditionIds: ['wind-cond-10'] },
  // ── Avian Study ──
  { id: 'wind-doc-15', dealId: 'wind-demo', documentType: 'due_diligence', title: 'Avian & Wildlife Study', fileName: 'Ridgeline_Avian_Study.pdf', fileType: 'application/pdf', storagePath: '/documents/wind-doc-15.pdf', status: 'uploaded', responsiblePartyId: 'wind-cp-1', uploadedAt: new Date('2028-01-10'), uploadedBy: 'gdunn@example.com', dueDate: new Date('2028-01-31'), signatures: [], satisfiesConditionIds: ['wind-cond-38'] },
];

const windClosingDeal: ClosingDeal = { id: 'wind-demo', name: 'Ridgeline Wind Farm', facilityAmount: 320_000_000, currency: 'USD', targetClosingDate: new Date('2028-02-20'), status: 'closing' };
...
const corporateNegotiationParties: DealParty[] = [
  { id: 'corp-party-borrower', dealId: 'corporate-demo', name: 'Calderon Industries Inc.', shortName: 'Borrower', role: 'borrower', partyType: 'borrower', primaryContact: { name: 'Laura Quinn', email: 'lquinn@example.com', phone: '+1 (312) 555-0100', title: 'CFO' }, additionalContacts: [], counselPartyId: 'corp-party-whitfield' },
  { id: 'corp-party-agent', dealId: 'corporate-demo', name: 'Northgate National Bank', shortName: 'Agent', role: 'administrative_agent', partyType: 'agent', primaryContact: { name: 'Kevin Doyle', email: 'kdoyle@example.com', phone: '+1 (212) 555-0200', title: 'Managing Director' }, additionalContacts: [], counselPartyId: 'corp-party-beckett' },
  { id: 'corp-party-whitfield', dealId: 'corporate-demo', name: 'Whitfield & Barr', shortName: 'Whitfield & Barr', role: 'borrower', partyType: 'law_firm', primaryContact: { name: 'Grant Weller', email: 'gweller@example.com', phone: '+1 (212) 555-0400', title: 'Partner' }, additionalContacts: [], counselPartyId: null },
  { id: 'corp-party-beckett', dealId: 'corporate-demo', name: 'Beckett Hale & Munro', shortName: 'Beckett', role: 'administrative_agent', partyType: 'law_firm', primaryContact: { name: 'Paula Rhodes', email: 'prhodes@example.com', phone: '+1 (212) 555-0500', title: 'Partner' }, additionalContacts: [], counselPartyId: null },
];

const corporateNegotiationVersions: DealVersion[] = [
  { id: 'corp-version-1', dealId: 'corporate-demo', versionNumber: 1, versionLabel: "Lender's Initial Draft", creditLangCode: '// Corporate - Lender Initial\nCOVENANT MaxLeverage REQUIRES Leverage <= 4.25\nBASKET GeneralInvestments CAPACITY $20_000_000', createdBy: 'prhodes@example.com', authorParty: 'Beckett', createdAt: new Date('2026-05-01'), parentVersionId: null, status: 'superseded', generatedWordDoc: null, changeSummary: null },
  { id: 'corp-version-2', dealId: 'corporate-demo', versionNumber: 2, versionLabel: "Borrower's Markup", creditLangCode: '// Corporate - Borrower Markup\nCOVENANT MaxLeverage REQUIRES Leverage <= 4.75 CURE EquityCure MAX_USES 3\nBASKET GeneralInvestments CAPACITY $30_000_000\nBASKET EBITDAInvestments CAPACITY 0.20 * EBITDA FLOOR $20_000_000', createdBy: 'gweller@example.com', authorParty: 'Whitfield & Barr', createdAt: new Date('2026-05-15'), parentVersionId: 'corp-version-1', status: 'superseded', generatedWordDoc: null, changeSummary: { versionFrom: 1, versionTo: 2, authorParty: 'Whitfield & Barr', createdAt: new Date('2026-05-15'), totalChanges: 3, covenantChanges: 1, definitionChanges: 0, basketChanges: 2, otherChanges: 0, borrowerFavorable: 3, lenderFavorable: 0, neutral: 0, changes: [
  ...
  { id: 'corp-version-3', dealId: 'corporate-demo', versionNumber: 3, versionLabel: 'Agreed Terms', creditLangCode: corporateCode, createdBy: 'prhodes@example.com', authorParty: 'Beckett', createdAt: new Date('2026-06-01'), parentVersionId: 'corp-version-2', status: 'executed', generatedWordDoc: null, changeSummary: { versionFrom: 2, versionTo: 3, authorParty: 'Beckett', createdAt: new Date('2026-06-01'), totalChanges: 2, covenantChanges: 1, definitionChanges: 0, basketChanges: 1, otherChanges: 0, borrowerFavorable: 0, lenderFavorable: 1, neutral: 1, changes: [
...
const corporateNegotiationDeal: Deal = {
  id: 'corporate-demo', name: 'Calderon Industries Credit Facility', dealType: 'corporate', facilityAmount: 150_000_000, currency: 'USD', status: 'active', currentVersionId: 'corp-version-3', parties: corporateNegotiationParties, targetClosingDate: new Date('2026-06-15'), actualClosingDate: new Date('2026-06-15'), maturityDate: new Date('2031-06-15'), createdAt: new Date('2026-04-15'), updatedAt: new Date('2026-06-15'), createdBy: 'kdoyle@example.com',
};

const corporateClosingParties: ClosingParty[] = [
  { id: 'corp-cp-1', dealId: 'corporate-demo', name: 'Calderon Industries Inc.', shortName: 'Borrower', role: 'borrower', partyType: 'borrower' },
  { id: 'corp-cp-2', dealId: 'corporate-demo', name: 'Northgate National Bank', shortName: 'Agent', role: 'administrative_agent', partyType: 'agent' },
  { id: 'corp-cp-3', dealId: 'corporate-demo', name: 'Whitfield & Barr', shortName: 'Borrower Counsel', role: 'counsel', partyType: 'law_firm' },
  { id: 'corp-cp-4', dealId: 'corporate-demo', name: 'Beckett Hale', shortName: 'Agent Counsel', role: 'counsel', partyType: 'law_firm' },
];

const corporateClosingConditions: ConditionPrecedent[] = [
  { id: 'corp-cond-1', dealId: 'corporate-demo', versionId: 'corp-version-3', sectionReference: '4.01(a)', category: 'credit_agreement', title: 'Credit Agreement Execution', description: 'Fully executed Credit Agreement', responsiblePartyId: 'corp-cp-3', status: 'satisfied', dueDate: new Date('2026-06-15'), satisfiedAt: new Date('2026-06-15'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'corp-cond-2', dealId: 'corporate-demo', versionId: 'corp-version-3', sectionReference: '4.01(b)', category: 'corporate_documents', title: 'Corporate Documents', description: 'Charter, bylaws, and resolutions', responsiblePartyId: 'corp-cp-1', status: 'satisfied', dueDate: new Date('2026-06-10'), satisfiedAt: new Date('2026-06-08'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'corp-cond-3', dealId: 'corporate-demo', versionId: 'corp-version-3', sectionReference: '4.01(c)', category: 'security_documents', title: 'Security Agreement', description: 'Security Agreement and UCC filings', responsiblePartyId: 'corp-cp-3', status: 'satisfied', dueDate: new Date('2026-06-15'), satisfiedAt: new Date('2026-06-15'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'corp-cond-4', dealId: 'corporate-demo', versionId: 'corp-version-3', sectionReference: '4.01(d)', category: 'legal_opinions', title: 'Legal Opinions', description: 'Borrower counsel and local counsel opinions', responsiblePartyId: 'corp-cp-3', status: 'satisfied', dueDate: new Date('2026-06-15'), satisfiedAt: new Date('2026-06-14'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'corp-cond-5', dealId: 'corporate-demo', versionId: 'corp-version-3', sectionReference: '4.01(e)', category: 'certificates', title: 'Solvency Certificate', description: 'CFO solvency certificate', responsiblePartyId: 'corp-cp-1', status: 'satisfied', dueDate: new Date('2026-06-15'), satisfiedAt: new Date('2026-06-15'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
  { id: 'corp-cond-6', dealId: 'corporate-demo', versionId: 'corp-version-3', sectionReference: '4.01(f)', category: 'financial', title: 'Financial Statements', description: 'Audited financials and compliance certificate', responsiblePartyId: 'corp-cp-1', status: 'satisfied', dueDate: new Date('2026-06-10'), satisfiedAt: new Date('2026-06-05'), satisfiedByDocumentIds: [], waivedAt: null, waiverApprovedBy: null, notes: '' },
];

const corporateClosingDocuments: ClosingDocument[] = [
  { id: 'corp-doc-1', dealId: 'corporate-demo', documentType: 'credit_agreement', title: 'Credit Agreement', fileName: 'Apex_Credit_Agreement.pdf', fileType: 'application/pdf', storagePath: '/documents/corp-doc-1.pdf', status: 'executed', responsiblePartyId: 'corp-cp-3', uploadedAt: new Date('2026-06-15'), uploadedBy: 'gweller@example.com', dueDate: new Date('2026-06-15'), signatures: [], satisfiesConditionIds: ['corp-cond-1'] },
];

const corporateClosingDeal: ClosingDeal = { id: 'corporate-demo', name: 'Calderon Industries Credit Facility', facilityAmount: 150_000_000, currency: 'USD', targetClosingDate: new Date('2026-06-15'), status: 'active' };
...
export const windScenario: DemoScenario = {
  id: 'wind-demo',
  name: 'Ridgeline Wind Farm',
  facility: '$320M Construction + Term Loan',
  sponsor: 'Ridgeline Energy Partners',
  borrower: 'Ridgeline Wind Holdings LLC',
  code: windCode,
...
export const corporateScenario: DemoScenario = {
  id: 'corporate-demo',
  name: 'Calderon Industries Credit Facility',
  facility: '$150M Revolving Credit Facility',
  sponsor: 'Calderon Industries Inc.',
  borrower: 'Calderon Industries Inc.',
  code: corporateCode,
