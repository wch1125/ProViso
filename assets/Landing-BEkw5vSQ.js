import{j as e}from"./index-BQHo3lY-.js";import{h as s,L as o}from"./vendor-react-C-GM1j7h.js";import{t as r}from"./analytics-CJOMXrsP.js";import{P as l,I as d,B as c,S as m,W as x,a as g,A as p,C as u,T as h,F as f,Z as y,b,c as v}from"./vendor-icons-SDImLkab.js";import{F as w}from"./Footer-CTDyV2Hc.js";import{T as j}from"./TopNav-x9KqDvYR.js";const N=[{id:"abc-acquisition",icon:c,name:"ABC Acquisition",description:"$150M leveraged buyout facility"},{id:"solar",icon:m,name:"Solar Utility",description:"200MW utility-scale solar with ITC tax equity"},{id:"wind",icon:x,name:"Wind Onshore",description:"150MW wind farm with PTC credits"},{id:"corporate",icon:g,name:"Corporate Revolver",description:"$150M revolving credit facility"}];function k({onSelectIndustry:t}){const n=s();return e.jsxs("section",{className:`
      ...
      `,children:[e.jsx("div",{className:`
        ...
        `}),e.jsxs("div",{className:"relative z-10 max-w-4xl mx-auto text-center",children:[e.jsxs("div",{className:`
          ...
          `,style:{animationDelay:"0.45s",animationFillMode:"forwards"},children:[e.jsxs("button",{onClick:()=>n("/demo"),className:`
            ...
            `,children:[e.jsx(l,{className:"w-4 h-4"}),"Explore a Live Deal"]}),e.jsxs(o,{to:"/about",className:`
            ...
            opacity-0 animate-fade-up
          `,style:{animationDelay:"0.5s",animationFillMode:"forwards"},children:N.map(a=>{const i=a.icon;return e.jsx("button",{onClick:()=>{r(a.id),t(a.id)},className:`
                ...
                `,children:e.jsxs("div",{className:"flex items-start gap-4",children:[e.jsx("div",{className:`
                      ...
                      transition-all duration-200
                    `,children:e.jsx(i,{className:"w-5 h-5 text-gold-400"})}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("h3",{className:"font-medium text-white mb-1 flex items-center gap-2",children:[a.name,e.jsx(p,{className:"w-4 h-4 text-gold-400 opacity-0 group-hover:opacity-100 transition-opacity"})]}),e.jsx("p",{className:"text-sm text-white/60 leading-snug",children:a.description})]})]})},a.id)})})]})]})}function F({icon:t,title:n,description:a,delay:i=0}){return e.jsxs("div",{className:`
      ...
      `,style:{animationDelay:`${i}ms`,animationFillMode:"forwards"},children:[e.jsx("div",{className:`
        ...
        `}),e.jsx("div",{className:`
          ...
          transition-all duration-300
        `,children:e.jsx(t,{className:"w-6 h-6 text-gold-500"})}),e.jsx("h3",{className:"font-display text-lg font-medium text-text-primary mb-2",children:n}),e.jsx("p",{className:"text-sm text-text-tertiary leading-relaxed",children:a})]})}const C=[{icon:u,title:"Instant Compliance",description:"Check covenant compliance in milliseconds, not weeks. Get definitive answers with citations to specific provisions."},{icon:h,title:"Basket Tracking",description:"Automatic utilization tracking with full audit trail. Know exactly how much capacity remains for investments, dividends, and debt."},{icon:f,title:"Plain English",description:"Source files read like the credit agreement. Lawyers can review and understand the logic without learning to code."},{icon:y,title:"Pro Forma Simulation",description:'"What if" analysis for proposed transactions. See instantly whether that acquisition or dividend would trip a covenant.'},{icon:b,title:"Cure Rights",description:"Built-in mechanics for covenant breaches. Track cure availability, equity contributions, and grace periods automatically."},{icon:v,title:"Project Finance",description:"Phases, milestones, waterfalls, and reserves. Full support for construction loans with draw conditions and CP checklists."}];function D(){return e.jsx("section",{className:"bg-surface-0 py-20 px-6",children:e.jsxs("div",{className:"max-w-6xl mx-auto",children:[e.jsxs("div",{className:"text-center mb-12 opacity-0 animate-fade-up",style:{animationDelay:"0.1s",animationFillMode:"forwards"},children:[e.jsx("h2",{className:"font-display text-sm font-semibold text-gold-500 uppercase tracking-[0.15em] mb-4",children:"What This Does"}),e.jsx("p",{className:"text-lg text-text-secondary max-w-2xl mx-auto",children:"Everything you need to make credit agreements executable"})]}),e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",children:C.map((t,n)=>e.jsx(F,{icon:t.icon,title:t.title,description:t.description,delay:100+n*50},t.title))})]})})}function A(){const t=s(),n=a=>{switch(a){case"abc-acquisition":t("/deals/abc-acquisition/negotiate");break;case"solar":t("/deals/solar-demo/monitor");break;case"wind":t("/deals/wind-demo/monitor");break;case"corporate":t("/deals/corporate-demo/monitor");break;default:t("/deals")}};return e.jsxs("div",{className:"min-h-screen bg-surface-0",children:[e.jsx(j,{}),e.jsx(k,{onSelectIndustry:n}),e.jsx(D,{}),e.jsx(w,{})]})}export{A as Landing,A as default};
